...
<input class="form-control search" id="inputusername" placeholder="Search here..." type="text"/>
...
<img alt="p3" class="img-fluid img" src="/assets/images/product/3.png"/>
</div>
</a>
</li>
<li>
...
<div class="categories-img">
<img alt="p21" class="img-fluid categories img" src="/assets/images/product/21.png"/>
</div>
</a>
</li>
<li>
...
<div class="categories-img">
<img alt="p11" class="img-fluid categories img" src="/assets/images/product/11.png"/>
</div>
</a>
</li>
<li>
...
<div class="categories-img">
<img alt="p22" class="img-fluid categories img" src="/assets/images/product/22.png"/>
</div>
</a>
</li>
<li>
...
<div class="categories-img">
<img alt="p23" class="img-fluid categories img" src="/assets/images/product/23.png"/>
</div>
</a>
</li>
<li>
...
<div class="categories-img">
<img alt="p24" class="img-fluid categories img" src="/assets/images/product/24.png"/>
</div>
</a>
</li>
<li>
...
<div class="categories-img">
<img alt="p25" class="img-fluid categories img" src="/assets/images/product/25.png"/>
</div>
</a>
</li>
</ul>
...
<a href="/landing">
<div class="icon">
<img alt="home" class="unactive" src="/assets/images/svg/home.svg"/>
<img alt="home" class="active" src="/assets/images/svg/home-fill.svg"/>
</div>
</a>
</li>
<li class="active">
<a href="/categories">
<div class="icon">
<img alt="categories" class="unactive" src="/assets/images/svg/categories.svg"/>
<img alt="categories" class="active" src="/assets/images/svg/categories-fill.svg"/>
</div>
</a>
</li>
<li>
<a href="/cart">
<div class="icon">
<img alt="bag" class="unactive" src="/assets/images/svg/bag.svg"/>
<img alt="bag" class="active" src="/assets/images/svg/bag-fill.svg"/>
</div>
</a>
</li>
<li>
<a href="/wishlist">
<div class="icon">
<img alt="heart" class="unactive" src="/assets/images/svg/heart.svg"/>
<img alt="heart" class="active" src="/assets/images/svg/heart-fill.svg"/>
</div>
</a>
</li>
<li>
<a href="/profile">
<div class="icon">
<img alt="profile" class="unactive" src="/assets/images/svg/profile.svg"/>
<img alt="profile" class="active" src="/assets/images/svg/profile-fill.svg"/>
</div>
</a>
</li>
</ul>
...
`;function Or(){return(0,M.jsx)(N,{html:Dr})}var kr=``,Ar=`fuzzy-access-token`,jr={get:()=>sessionStorage.getItem(Ar),set:e=>sessionStorage.setItem(Ar,e),clear:()=>sessionStorage.removeItem(Ar)},krUser=`fuzzy-demo-user`,krToken=`demo.`+btoa(JSON.stringify({exp:4102444800}))+`.token`;function krDefaultUser(e=`khongcanbiet@gmail.com`,t=`Khong Can Biet`){return{id:`demo-user`,email:e,fullName:t,role:`customer`,status:`active`,avatar:`/assets/images/icons/profile.png`,createdAt:new Date().toISOString(),addresses:[{id:`demo-address`,label:`Home`,recipientName:t,phone:`0900000000`,street:`Demo street`,city:`Ho Chi Minh`,postalCode:`70000`,landmark:``,isDefault:!0}]}}function Mr(e){try{let t=JSON.parse(atob(e.split(`.`)[1]));return!t.exp||t.exp*1e3<=Date.now()}catch{return!0}}async function Nr(e,t={}){let n=t.body?JSON.parse(t.body):{},r=JSON.parse(localStorage.getItem(krUser)??`null`)??krDefaultUser(),i=()=>({id:`demo-order`,code:`TFZ-100001`,createdAt:new Date().toISOString(),status:`pending`,total:126,items:[{productId:`product-2`,name:`Nordic Fabric Sofa`,image:`/assets/images/product/2.png`,price:126,quantity:1,color:`#122636`,size:`M`}],shippingAddress:r.addresses[0],paymentMethod:`cod`,paymentStatus:`pending`,statusHistory:[{status:`pending`,note:`Order created.`,at:new Date().toISOString()}]});if(e===`/auth/login`){let e=krDefaultUser(n.email||`khongcanbiet@gmail.com`,(n.email||`Demo User`).split(`@`)[0]);return localStorage.setItem(krUser,JSON.stringify(e)),{token:krToken,user:e}}if(e===`/auth/register`){let e=krDefaultUser(n.email,n.fullName);return localStorage.setItem(krUser,JSON.stringify(e)),{token:krToken,user:e,requiresApproval:!1}}if(e===`/users/me`)return{user:r};if(e===`/orders`&&t.method===`POST`)return{order:{...i(),id:`demo-order-${Date.now()}`,code:`TFZ-${Date.now().toString().slice(-6)}`,shippingAddress:r.addresses.find(e=>e.id===n.addressId)??r.addresses[0],paymentMethod:n.paymentMethod??`cod`}};if(e===`/orders`)return{orders:[i()]};if(e.startsWith(`/orders/`))return{order:{...i(),id:e.split(`/`).pop()}};return{}}var Pr=(0,x.createContext)(null);function Fr({children:e}){let[t,n]=(0,x.useState)(null),[r,i]=(0,x.useState)(!0),a=(0,x.useCallback)(()=>{jr.clear(),n(null)},[]),o=(0,x.useCallback)(async()=>{let e=jr.get();if(!e||Mr(e)){a();return}n((await Nr(`/users/me`)).user)},[a]);(0,x.useEffect)(()=>{o().catch(a).finally(()=>i(!1));let e=()=>a();window.addEventListener(`auth:expired`,e);let t=window.setInterval(()=>{let e=jr.get();e&&Mr(e)&&a()},15e3);return()=>{window.removeEventListener(`auth:expired`,e),window.clearInterval(t)}},[a,o]);async function s(e,t){let r=await Nr(e,{method:`POST`,body:JSON.stringify(t)});jr.set(r.token),n(r.user)}async function c(e,t,r){let i=await Nr(`/auth/register`,{method:`POST`,body:JSON.stringify({fullName:e,email:t,password:r})});return i.token&&(jr.set(i.token),n(i.user)),{requiresApproval:i.requiresApproval}}let l=(0,x.useMemo)(()=>({user:t,loading:r,login:(e,t)=>s(`/auth/login`,{email:e,password:t}),register:c,logout:a,refreshUser:o,setUser:n}),[r,a,o,t]);return(0,M.jsx)(Pr.Provider,{value:l,children:e})}function Ir(){let e=(0,x.useContext)(Pr);if(!e)throw Error(`useAuth must be used inside AuthProvider`);return e}var Lr=[{id:`cod`,name:`Cash on delivery`,detail:`Pay when your order arrives`},{id:`bank_transfer`,name:`Bank transfer`,detail:`Transfer using the order code`},{id:`vnpay`,name:`VNPay`,detail:`Sandbox credentials required`},{id:`momo`,name:`MoMo`,detail:`Sandbox credentials required`}];function Rr(){let{user:e}=Ir(),t=vr(),[n,r]=(0,x.useState)(1),[i,a]=(0,x.useState)(e?.addresses.find(e=>e.isDefault)?.id??e?.addresses[0]?.id??``),[o,s]=(0,x.useState)(`cod`),[c,l]=(0,x.useState)(null),[u,d]=(0,x.useState)(``),[f,p]=(0,x.useState)(!1),m=t.reduce((e,t)=>e+t.product.price*t.quantity,0);async function h(){p(!0),d(``);try{l((await Nr(`/orders`,{method:`POST`,body:JSON.stringify({addressId:i,paymentMethod:o,items:t.map(e=>({productId:e.product.id,quantity:e.quantity,color:e.color,size:e.size}))})})).order),yr([]),r(3)}catch(e){d(e instanceof Error?e.message:`Could not place order.`)}finally{p(!1)}}return n===3&&c?(0,M.jsxs)(`div`,{className:`order-success`,children:[(0,M.jsx)(`div`,{children:`âœ“`}),(0,M.jsx)(`h1`,{children:`Order placed!`}),(0,M.jsx)(`p`,{children:`Your order code`}),(0,M.jsx)(`strong`,{children:c.code}),(0,M.jsx)(`p`,{children:`We will update you as the order moves.`}),(0,M.jsx)(j,{to:`/order-tracking/${c.id}`,children:`Track order`}),(0,M.jsx)(j,{className:`secondary`,to:`/landing`,children:`Continue shopping`})]}):(0,M.jsxs)(`div`,{className:`checkout-flow`,children:[(0,M.jsxs)(`header`,{className:`header-panel custom-container section-t-space`,children:[(0,M.jsx)(j,{to:n===1?`/cart`:`#`,onClick:()=>n>1&&r(1),children:`â†`}),(0,M.jsx)(`h3`,{children:`Checkout`}),(0,M.jsxs)(`span`,{children:[n,`/2`]})]}),(0,M.jsxs)(`div`,{className:`checkout-progress`,children:[(0,M.jsx)(`i`,{className:`active`}),(0,M.jsx)(`i`,{className:n>=2?`active`:``})]}),(0,M.jsx)(`main`,{className:`custom-container`,children:n===1?(0,M.jsxs)(`section`,{children:[(0,M.jsx)(`h2`,{children:`Shipping address`}),!e?.addresses.length&&(0,M.jsxs)(`div`,{className:`checkout-empty`,children:[`You have no saved address. `,(0,M.jsx)(j,{to:`/new-address`,children:`Add address`})]}),(0,M.jsx)(`div`,{className:`checkout-addresses`,children:e?.addresses.map(e=>(0,M.jsxs)(`label`,{className:i===e.id?`selected`:``,children:[(0,M.jsx)(`input`,{checked:i===e.id,onChange:()=>a(e.id),type:`radio`}),(0,M.jsxs)(`div`,{children:[(0,M.jsxs)(`strong`,{children:[e.label,` `,e.isDefault&&(0,M.jsx)(`small`,{children:`Default`})]}),(0,M.jsxs)(`p`,{children:[e.recipientName,`, `,e.street,`, `,e.city,` `,e.postalCode]}),(0,M.jsx)(`span`,{children:e.phone})]})]},e.id))}),(0,M.jsx)(`button`,{className:`checkout-next`,disabled:!i||!t.length,onClick:()=>r(2),children:`Continue to payment`})]}):(0,M.jsxs)(`section`,{children:[(0,M.jsx)(`h2`,{children:`Payment method`}),(0,M.jsx)(`div`,{className:`payment-methods`,children:Lr.map(e=>(0,M.jsxs)(`label`,{className:o===e.id?`selected`:``,children:[(0,M.jsx)(`input`,{checked:o===e.id,onChange:()=>s(e.id),type:`radio`}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`strong`,{children:e.name}),(0,M.jsx)(`p`,{children:e.detail})]})]},e.id))}),(0,M.jsxs)(`div`,{className:`order-summary`,children:[(0,M.jsx)(`h3`,{children:`Order summary`}),(0,M.jsxs)(`p`,{children:[(0,M.jsx)(`span`,{children:`Subtotal`}),(0,M.jsxs)(`b`,{children:[`$`,m.toFixed(2)]})]}),(0,M.jsxs)(`p`,{children:[(0,M.jsx)(`span`,{children:`Shipping`}),(0,M.jsx)(`b`,{children:m>=100?`Free`:`$5.00`})]}),(0,M.jsxs)(`p`,{className:`total`,children:[(0,M.jsx)(`span`,{children:`Total`}),(0,M.jsxs)(`b`,{children:[`$`,(m+(m>=100?0:5)).toFixed(2)]})]})]}),u&&(0,M.jsx)(`p`,{className:`form-message`,children:u}),(0,M.jsx)(`button`,{className:`checkout-next`,disabled:f,onClick:h,children:f?`Placing order...`:`Place order`})]})})]})}var zr=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<div class="coupon-discount"><span>60% </span> OFF</div>
<div class="coupon-details">
<h4 class="fw-semibold theme-color">Google Pay</h4>
<p>Buy 1 phone and get 10% off on second phone.</p>
<div class="coupon-apply">
<h6 class="light-text">#GOOGLE20</h6>
<a class="apply-btn theme-color fw-semibold" href="/checkout">apply</a>
</div>
</div>
<img alt="subtract" class="img-fluid coupon-right" src="/assets/images/subtract.png"/>
</div>
</div>
<div class="col-12">
<div class="coupon-box">
...
`;function Br(){return(0,M.jsx)(N,{html:zr})}function Vr(){let e=_t(),{register:t}=Ir(),[n,r]=(0,x.useState)(``),[i,a]=(0,x.useState)(``),[o,s]=(0,x.useState)(``),[c,l]=(0,x.useState)(!1),[u,d]=(0,x.useState)(``),[f,p]=(0,x.useState)(!1);(0,x.useEffect)(()=>(document.body.classList.add(`auth-body`),Tr(),()=>document.body.classList.remove(`auth-body`)),[]);async function m(r){if(r.preventDefault(),d(``),n.trim().length<2)return d(`Name must contain at least 2 characters.`);if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(i))return d(`Please enter a valid email.`);if(!/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^A-Za-z0-9]).{8,}$/.test(o))return d(`Password needs 8+ characters, uppercase, lowercase, number and symbol.`);p(!0);try{(await t(n.trim(),i.trim(),o)).requiresApproval?e(`/login`,{replace:!0,state:{notice:`ÄÄƒng kÃ½ thÃ nh cÃ´ng. TÃ i khoáº£n Ä‘ang chá» Admin duyá»‡t.`}}):e(`/landing`,{replace:!0})}catch(e){d(e instanceof Error?e.message:`Registration failed.`)}finally{p(!1)}}return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsxs)(`div`,{className:`auth-img`,children:[(0,M.jsx)(`img`,{alt:``,className:`img-fluid auth-bg`,src:`/assets/images/background/auth_bg.jpg`}),(0,M.jsx)(`div`,{className:`auth-content`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{children:`Let's get you in`}),(0,M.jsx)(`h4`,{className:`p-0`,children:`Create your Fuzzy account`})]})})]}),(0,M.jsx)(`form`,{className:`auth-form`,noValidate:!0,onSubmit:m,children:(0,M.jsxs)(`div`,{className:`custom-container`,children:[(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{className:`form-label`,htmlFor:`registerName`,children:`Full name`}),(0,M.jsxs)(`div`,{className:`form-input mb-4`,children:[(0,M.jsx)(`input`,{className:`form-control`,id:`registerName`,onChange:e=>r(e.target.value),placeholder:`Enter Your Name`,value:n}),(0,M.jsx)(`i`,{className:`iconsax icons`,"data-icon":`user-1`})]})]}),(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{className:`form-label`,htmlFor:`registerEmail`,children:`Email id`}),(0,M.jsxs)(`div`,{className:`form-input mb-4`,children:[(0,M.jsx)(`input`,{className:`form-control`,id:`registerEmail`,onChange:e=>a(e.target.value),placeholder:`Enter Your Email`,type:`email`,value:i}),(0,M.jsx)(`i`,{className:`iconsax icons`,"data-icon":`mail`})]})]}),(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{className:`form-label`,htmlFor:`registerPassword`,children:`Password`}),(0,M.jsxs)(`div`,{className:`form-input`,children:[(0,M.jsx)(`input`,{className:`form-control`,id:`registerPassword`,onChange:e=>s(e.target.value),placeholder:`Enter Your Password`,type:c?`text`:`password`,value:o}),(0,M.jsx)(`i`,{className:`iconsax icons`,"data-icon":`key`}),(0,M.jsx)(`button`,{className:`password-toggle`,onClick:()=>l(e=>!e),type:`button`,children:c?`Hide`:`Show`})]})]}),u&&(0,M.jsx)(`p`,{className:`login-error`,role:`alert`,children:u}),(0,M.jsx)(`div`,{className:`submit-btn`,children:(0,M.jsx)(`button`,{className:`btn auth-btn w-100`,disabled:f,type:`submit`,children:f?`Creating...`:`Sign Up`})}),(0,M.jsxs)(`h4`,{className:`signup`,children:[`Already have an account? `,(0,M.jsx)(j,{to:`/login`,children:`Sign in`})]})]})})]})}var Hr=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<div class="custom-container">
<div class="empty-tab">
<img alt="empty-cart" class="img-fluid empty-img w-100" src="/assets/images/gif/cart.gif"/>
<h2>Your luggage is empty.</h2>
<h5 class="mt-3">Check out our top products to get the right one for you.</h5>
<a class="btn theme-btn w-100 mt-3 mb-3" href="/landing" role="button">Start Shopping</a>
</div>
</div>
 cart end 
 iconsax js 
...
`;function Ur(){return(0,M.jsx)(N,{html:Hr})}var Wr=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<div class="custom-container">
<div class="empty-tab">
<img alt="empty-bell" class="img-fluid empty-img w-100" src="/assets/images/gif/notifiction.gif"/>
<h2>No Notifications Found!!</h2>
<h5 class="mt-3">You donâ€™t have new notification right now. If we received anything we will notify you.</h5>
<a class="btn theme-btn w-100 mt-5" href="/notification" role="button">Refresh</a>
</div>
</div>
</section>
 Notification end 
...
`;function Gr(){return(0,M.jsx)(N,{html:Wr})}var Kr=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<div class="custom-container">
<div class="empty-tab">
<img alt="empty-order" class="img-fluid empty-img w-100" src="/assets/images/gif/order.gif"/>
<h2>No Order Available</h2>
<h5 class="mt-3">If you haven't made any order yet, do so now for a better life.</h5>
</div>
</div>
</section>
 order history end 
...
`;function qr(){return(0,M.jsx)(N,{html:Kr})}var Jr=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<div class="custom-container">
<div class="empty-tab">
<img alt="empty-search" class="img-fluid empty-img w-100" src="/assets/images/gif/search.gif"/>
<h2>No Result to Show</h2>
<h5 class="mt-3">Please check your spelling or try different key word.</h5>
</div>
</div>
</section>
 search end 
...
`;function Yr(){return(0,M.jsx)(N,{html:Jr})}var Xr=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<div class="custom-container">
<div class="empty-tab">
<img alt="empty-wishlist" class="img-fluid empty-img img1 w-100" src="/assets/images/gif/wishlist.gif"/>
<h2>Your Wishlist is Empty!!</h2>
<h5 class="mt-3">If you haven't made any wishes yet, do so now for a better life.</h5>
<a class="btn theme-btn w-100 mt-5" href="/landing" role="button">Add Now</a>
</div>
</div>
</section>
 Notification end 
...
`;function Zr(){return(0,M.jsx)(N,{html:Xr})}var Qr=`
 forgot password section start 
<div class="auth-img">
<img alt="auth_bg" class="img-fluid auth-bg" src="/assets/images/background/auth_bg.jpg"/>
...
<div class="custom-container">
<div class="form-group">
<label class="form-label" for="inputusername">Email id</label>
<div class="form-input mb-4">
<input class="form-control" id="inputusername" placeholder="Enter Your Email" type="text"/>
<i class="iconsax icons" data-icon="mail"></i>
</div>
</div>
<div class="submit-btn">
<a class="btn auth-btn w-100" href="/otp">Send OTP</a>
</div>
</div>
</form>
...
`;function $r(){return(0,M.jsx)(N,{html:Qr})}var ei=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<img alt="help" class="img-fluid help-pic" src="/assets/images/banner/help-pic.png"/>
<h2>Help Center</h2>
...
<button aria-expanded="false" class="accordion-button collapsed" data-bs-target="#flush-collapseOne" data-bs-toggle="collapse" type="button">I want to track my order</button>
</h2>
<div class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample" id="flush-collapseOne">
<div class="accordion-body">To track your order, you will need to have the tracking number or order ID provided by the seller or shipping carrier. Once you have this information, you can usually track your order online by visiting the carrier's website and entering the tracking number or order ID in the designated tracking field.</div>
</div>
</div>
<div class="accordion-item">
<h2 class="accordion-header">
<button aria-controls="flush-collapseTwo" aria-expanded="false" class="accordion-button collapsed" data-bs-target="#flush-collapseTwo" data-bs-toggle="collapse" type="button">I want to manage my order</button>
</h2>
...
<div class="accordion-item">
<h2 class="accordion-header">
<button aria-controls="flush-collapseThree" aria-expanded="false" class="accordion-button collapsed" data-bs-target="#flush-collapseThree" data-bs-toggle="collapse" type="button">I did not receive Instant Cashback</button>
</h2>
...
<div class="accordion-item">
<h2 class="accordion-header">
<button aria-controls="flush-collapseFour" aria-expanded="false" class="accordion-button collapsed" data-bs-target="#flush-collapseFour" data-bs-toggle="collapse" type="button">I am unable to pay using wallet</button>
</h2>
...
<div class="accordion-item">
<h2 class="accordion-header">
<button aria-controls="flush-collapseFive" aria-expanded="false" class="accordion-button collapsed" data-bs-target="#flush-collapseFive" data-bs-toggle="collapse" type="button">I want help with returns &amp; refunds</button>
</h2>
...
`;function ti(){return(0,M.jsx)(N,{html:ei})}var ni=`
<section class="section-b-space">
<div class="swiper intro slider-1">
<div class="swiper-wrapper">
<div class="swiper-slide">
<div class="theme-logo pb-3">
<img alt="logo" class="img-fluid logo-img" src="/assets/images/logo/logo.png"/>
</div>
<div class="onboarding-design">
<img alt="bg-design" class="img-fluid design-img" src="/assets/images/onboarding/design1.png"/>
<img alt="slider-1" class="img-fluid slider-img1" src="/assets/images/onboarding/1.png"/>
<img alt="v1" class="img-fluid vector1" src="/assets/images/onboarding/vector1.png"/>
<img alt="v2" class="img-fluid vector2" src="/assets/images/onboarding/vector2.png"/>
<img alt="v3" class="img-fluid vector3" src="/assets/images/onboarding/vector3.png"/>
</div>
...
<div class="onboarding-design">
<img alt="bg-design" class="img-fluid design-img" src="/assets/images/onboarding/design1.png"/>
<img alt="slider-2" class="img-fluid slider-img2" src="/assets/images/onboarding/2.png"/>
<img alt="v1" class="img-fluid vector1" src="/assets/images/onboarding/vector1.png"/>
<img alt="v2" class="img-fluid vector2" src="/assets/images/onboarding/vector2.png"/>
<img alt="v3" class="img-fluid vector3" src="/assets/images/onboarding/vector3.png"/>
</div>
...
<div class="onboarding-design">
<img alt="bg-design" class="img-fluid design-img" src="/assets/images/onboarding/design1.png"/>
<img alt="slider-3" class="img-fluid slider-img3" src="/assets/images/onboarding/3.png"/>
<img alt="v1" class="img-fluid vector1" src="/assets/images/onboarding/vector1.png"/>
<img alt="v2" class="img-fluid vector2" src="/assets/images/onboarding/vector2.png"/>
<img alt="v3" class="img-fluid vector3" src="/assets/images/onboarding/vector3.png"/>
<div class="product-details">
...
<div class="offcanvas offcanvas-bottom addtohome-popup theme-offcanvas" id="offcanvas" tabindex="-1">
<button aria-label="Close" class="btn-close text-reset" data-bs-dismiss="offcanvas" type="button"></button>
<div class="offcanvas-body small">
<div class="app-info">
<img alt="" class="img-fluid" src="/assets/images/logo/48.png"/>
<div class="content">
<h4>fuzzy app</h4>
<a href="#">www.fuzzy-app.com</a>
</div>
</div>
<a class="btn theme-btn install-app btn-inline home-screen-btn m-0" href="#!" id="installapp">Add to Home Screen</a>
</div>
</div>
`;function ri(){return(0,M.jsx)(N,{html:ni,bodyClassName:`auth-body`})}var ii=`
 side bar start 
<div class="offcanvas sidebar-offcanvas offcanvas-start" id="offcanvasLeft" tabindex="-1">
<div class="offcanvas-header">
<img alt="profile" class="img-fluid profile-pic" src="/assets/images/icons/profile.png"/>
<h4>Hello, Agasya!</h4>
...
<li>
<a class="pages" href="/page-listing">
<h4>Pages List</h4>
<i class="ri-arrow-drop-right-line"></i>
</a>
</li>
<li>
<a class="pages" href="/setting">
<h4>Setting</h4>
<i class="ri-arrow-drop-right-line"></i>
</a>
</li>
<li>
<a class="pages" href="/login">
<h4>Logout</h4>
<i class="ri-arrow-drop-right-line"></i>
</a>
</li>
...
<button class="sidebar-btn" data-bs-target="#offcanvasLeft" data-bs-toggle="offcanvas" type="button">
...
<a class="btn filter-btn mt-0" data-bs-toggle="modal" href="#search-filter">
...
<div class="custom-container">
<div class="banner-bg">
<img alt="banner-1" class="img-fluid img-bg w-100" src="/assets/images/banner/banner-1.jpg"/>
<div class="banner-content">
<h2 class="fw-semibold">Best Selling</h2>
<h4>Comforts &amp; Modern life Stylish Sofa</h4>
</div>
<a class="more-btn" href="/shop">
<h4>View More</h4>
<i class="iconsax right-arrow" data-icon="arrow-right"></i>
</a>
</div>
...
<div class="swiper-slide">
<a class="categories-item active" href="#">
<img alt="sofa" class="categories-img" src="/assets/images/svg/sofa.svg"/>
<h4>Sofa</h4>
</a>
</div>
<div class="swiper-slide">
<a class="categories-item" href="/shop">
<h4>Chair</h4>
</a>
</div>
<div class="swiper-slide">
...
<a href="/shop"><img alt="p1" class="img" src="/assets/images/product/1.png"/></a>
<div class="cart-box">
...
<img alt="like" class="outline-icon" src="/assets/images/svg/like.svg"/>
<img alt="like" class="fill-icon" src="/assets/images/svg/like-fill.svg"/>
...
<div class="rating">
<img alt="star" src="/assets/images/svg/Star.svg"/>
<h6>4.5</h6>
</div>
</div>
</div>
...
<div class="product-box-img">
<a href="/shop">
<img alt="p2" class="img" src="/assets/images/product/2.png"/>
</a>
<div class="cart-box">
<a class="cart-bag" href="/cart">
<i class="iconsax bag" data-icon="basket-2"></i>
...
<a class="horizontal-product-img" href="/product-details">
<img alt="p3" class="img-fluid img" src="/assets/images/product/3.png"/>
</a>
...
<div class="horizontal-product-box">
<a class="horizontal-product-img" href="/product-details">
<img alt="p4" class="img-fluid img" src="/assets/images/product/4.png"/>
</a>
<div class="horizontal-product-details">
<div class="d-flex align-items-center justify-content-between">
...
<div class="horizontal-product-box">
<a class="horizontal-product-img" href="/product-details">
<img alt="p5" class="img-fluid img" src="/assets/images/product/5.png"/>
</a>
<div class="horizontal-product-details">
<div class="d-flex align-items-center justify-content-between">
<h4>Beige Chair</h4>
...
<div class="custom-container">
<div class="banner-bg">
<img alt="banner-2" class="img-fluid img-bg" src="/assets/images/banner/banner-2.jpg"/>
<div class="banner-content">
<h2 class="fw-semibold">Best Selling</h2>
<h4>Comforts &amp; Modern life Stylish Sofa</h4>
</div>
...
<div class="horizontal-product-box">
<a class="horizontal-product-img" href="/product-details">
<img alt="p6" class="img-fluid img" src="/assets/images/product/6.png"/>
</a>
<div class="horizontal-product-details">
<div class="d-flex align-items-center justify-content-between">
<h4>Table Lamp</h4>
...
<a class="horizontal-product-img" href="/product-details">
<img alt="p7" class="img-fluid img" src="/assets/images/product/7.png"/>
</a>
<div class="horizontal-product-details">
<div class="d-flex align-items-center justify-content-between">
<h4>Side Table</h4>
...
<div class="horizontal-product-box">
<a class="horizontal-product-img" href="/product-details">
<img alt="p8" class="img-fluid img" src="/assets/images/product/8.png"/>
</a>
<div class="horizontal-product-details">
<div class="d-flex align-items-center justify-content-between">
<h4>Lounge Chair</h4>
...
<div class="horizontal-product-box mt-3">
<a class="horizontal-product-img" href="/product-details">
<img alt="p9" class="img-fluid img" src="/assets/images/product/9.png"/>
</a>
<div class="horizontal-product-details">
<div class="d-flex align-items-center justify-content-between">
<h4>Swing Chair</h4>
...
<div class="product-box">
<div class="product-box-img">
<a href="/shop"> <img alt="p10" class="img" src="/assets/images/product/10.png"/></a>
<div class="cart-box">
<a class="cart-bag" href="/cart">
<i class="iconsax bag" data-icon="basket-2"></i>
</a>
...
<div class="product-box">
<div class="product-box-img">
<a href="/shop"> <img alt="p11" class="img" src="/assets/images/product/11.png"/></a>
<div class="cart-box">
<a class="cart-bag" href="/cart">
<i class="iconsax bag" data-icon="basket-2"></i>
</a>
...
<div class="product-box">
<div class="product-box-img">
<a href="/shop"> <img alt="p12" class="img" src="/assets/images/product/12.png"/></a>
<div class="cart-box">
<a class="cart-bag" href="/cart">
<i class="iconsax bag" data-icon="basket-2"></i>
</a>
...
<div class="product-box">
<div class="product-box-img">
<a href="/shop"> <img alt="p13" class="img" src="/assets/images/product/13.png"/></a>
<div class="cart-box">
<a class="cart-bag" href="/cart">
<i class="iconsax bag" data-icon="basket-2"></i>
</a>
...
<div class="col-6">
<div class="banner-bg">
<img alt="banner-3" class="img-fluid img-bg" src="/assets/images/banner/banner-3.jpg"/>
<div class="banner-content">
<h3>Wingback Chair</h3>
</div>
<a class="more-btn d-block" href="/shop">
<i class="iconsax right-arrow" data-icon="arrow-right"></i>
<h3>View More</h3>
</a>
...
<div class="col-6">
<div class="banner-bg">
<img alt="banner-3" class="img-fluid img-bg" src="/assets/images/banner/banner-4.jpg"/>
<div class="banner-content">
<h3>Wingback Chair</h3>
</div>
<a class="more-btn d-block" href="/shop">
...
<a data-bs-dismiss="modal" href="/landing">
<i class="iconsax back-btn" data-icon="arrow-left"></i>
</a>
...
<button aria-controls="v-pills-sort" aria-selected="true" class="nav-link active" data-bs-target="#v-pills-sort" data-bs-toggle="pill" id="v-pills-sort-tab" role="tab" type="button">Sort By</button>
<button aria-controls="v-pills-color" aria-selected="false" class="nav-link" data-bs-target="#v-pills-color" data-bs-toggle="pill" id="v-pills-color-tab" role="tab" type="button">Color</button>
<button aria-controls="v-pills-price" aria-selected="false" class="nav-link" data-bs-target="#v-pills-price" data-bs-toggle="pill" id="v-pills-price-tab" role="tab" type="button">Price</button>
<button aria-controls="v-pills-material" aria-selected="false" class="nav-link" data-bs-target="#v-pills-material" data-bs-toggle="pill" id="v-pills-material-tab" role="tab" type="button">Material</button>
</div>
<div class="tab-content" id="v-pills-tabContent">
<div aria-labelledby="v-pills-sort-tab" class="tab-pane tab-info fade show active" id="v-pills-sort" role="tabpanel" tabindex="0">
<div class="form-check">
<input class="form-check-input" id="radio1" name="flexRadioDefault" type="radio"/>
...
<div class="form-check">
<input checked="" class="form-check-input" id="radio3" name="radio" type="radio"/>
<label class="form-check-label" for="radio3">Lowest Priced First</label>
</div>
<div class="form-check">
<input class="form-check-input" id="radio4" name="radio" type="radio"/>
<label class="form-check-label" for="radio4">Fastest Shipping</label>
</div>
<div class="form-check">
<input class="form-check-input" id="radio5" name="radio" type="radio"/>
<label class="form-check-label" for="radio5">Newest</label>
</div>
<div class="form-check">
<input class="form-check-input" id="radio6" name="radio" type="radio"/>
<label class="form-check-label" for="radio6">Highest Rating First</label>
</div>
</div>
<div aria-labelledby="v-pills-color-tab" class="tab-pane tab-info color-info fade" id="v-pills-color" role="tabpanel" tabindex="0">
<div class="form-check">
<input class="form-check-input" id="color1" type="checkbox" value=""/>
<label class="form-check-label" for="color1">Black</label>
</div>
<div class="form-check">
<input class="form-check-input" id="color2" type="checkbox" value=""/>
<label class="form-check-label" for="color2">Gray</label>
</div>
<div class="form-check">
<input class="form-check-input" id="color3" type="checkbox" value=""/>
<label class="form-check-label" for="color3">Blue</label>
</div>
<div class="form-check">
<input class="form-check-input" id="color4" type="checkbox" value=""/>
<label class="form-check-label" for="color4">Yellow</label>
</div>
<div class="form-check">
<input class="form-check-input" id="color5" type="checkbox" value=""/>
<label class="form-check-label" for="color5">Green</label>
</div>
<div class="form-check">
<input class="form-check-input" id="color6" type="checkbox" value=""/>
<label class="form-check-label" for="color6">Red</label>
</div>
</div>
<div aria-labelledby="v-pills-price-tab" class="tab-pane price-info fade" id="v-pills-price" role="tabpanel" tabindex="0">
<div class="range-slider">
<span>From <input max="100000" min="0" step="50" type="number" value="250"/> To <input max="1000" min="0" step="50" type="number" value="750"/> </span>
<input max="1000" min="0" step="50" type="range" value="250"/>
<input max="1000" min="0" step="50" type="range" value="500"/>
<svg height="24" width="100%">
<line stroke="#444" stroke-dasharray="1 28" stroke-width="12" x1="4" x2="480" y1="0" y2="0"></line>
</svg>
</div>
</div>
<div aria-labelledby="v-pills-material-tab" class="tab-pane tab-info fade" id="v-pills-material" role="tabpanel" tabindex="0">
<div class="form-check">
<input class="form-check-input" id="flexRadioDefault1" name="flexRadioDefault" type="checkbox"/>
<label class="form-check-label" for="flexRadioDefault1">Fabric</label>
</div>
<div class="form-check">
<input checked="" class="form-check-input" id="flexRadioDefault2" name="flexRadioDefault" type="checkbox"/>
<label class="form-check-label" for="flexRadioDefault2">Wooden</label>
</div>
<div class="form-check">
<input class="form-check-input" id="flexRadioDefault3" name="flexRadioDefault" type="checkbox"/>
<label class="form-check-label" for="flexRadioDefault2">Metal</label>
</div>
<div class="form-check">
<input class="form-check-input" id="flexRadioDefault4" name="flexRadioDefault" type="checkbox"/>
<label class="form-check-label" for="flexRadioDefault1">Plastic</label>
</div>
<div class="form-check">
<input class="form-check-input" id="flexRadioDefault5" name="flexRadioDefault" type="checkbox"/>
...
<a class="btn gray-btn btn-inline mt-0 w-50" href="/landing">Clear Filter</a>
<a class="theme-btn btn btn-inline mt-0 w-50" data-bs-dismiss="modal" href="/landing">apply</a>
</div>
</div>
</div>
</div>
...
`,ai=`fuzzy-wishlist`;function oi(){try{return JSON.parse(localStorage.getItem(ai)??`[]`)}catch{return[]}}function si(e){localStorage.setItem(ai,JSON.stringify(e)),window.dispatchEvent(new Event(`wishlist:changed`))}function ci(e){return oi().some(t=>t.id===e)}function li(e){let t=oi(),n=t.findIndex(t=>t.id===e.id);return n>=0?t.splice(n,1):t.unshift(e),si(t),n<0}var ui=`https://trungfuzzy-api.vercel.app/api`;function di(e){return e.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#039;`})[e]??e)}function fi(){let{user:e}=Ir(),t=di(e?.fullName.trim()||`Agasya`),n=di(e?.avatar||`/assets/images/icons/profile.png`),r=ii.split(`Agasya!`).join(`${t}!`).split(`src="/assets/images/icons/profile.png"`).join(`src="${n}"`);return(0,x.useEffect)(()=>{let e=!0,t=[];return fetch(`${ui}/products?limit=30`).then(e=>e.json()).then(({items:n})=>{e&&document.querySelectorAll(`.product-box .like-btn`).forEach((e,r)=>{let i=n[r];if(!i)return;e.classList.toggle(`active`,ci(i.id));let a=()=>{let t=li(i);e.classList.toggle(`active`,t),e.classList.toggle(`inactive`,!t)};e.addEventListener(`click`,a),t.push(()=>e.removeEventListener(`click`,a))})}),()=>{e=!1,t.forEach(e=>e())}},[r]),(0,M.jsx)(N,{html:r})}var pi=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<input checked="" class="form-check-input" id="radio1" name="exampleRadios" type="radio" value="option1"/>
</div>
</li>
<li class="w-100">
<div class="form-check form-check-reverse">
<label class="form-check-label" for="radio2">Spanish</label>
<input class="form-check-input" id="radio2" name="exampleRadios" type="radio" value="option2"/>
</div>
</li>
<li class="w-100">
<div class="form-check form-check-reverse">
<label class="form-check-label" for="radio3">France</label>
<input class="form-check-input" id="radio3" name="exampleRadios" type="radio" value="option3"/>
</div>
</li>
<li class="w-100">
<div class="form-check form-check-reverse">
<label class="form-check-label" for="radio4">Portuguese</label>
<input class="form-check-input" id="radio4" name="exampleRadios" type="radio" value="option4"/>
</div>
</li>
<li class="w-100">
<div class="form-check form-check-reverse">
<label class="form-check-label" for="radio5">Russian</label>
<input class="form-check-input" id="radio5" name="exampleRadios" type="radio" value="option5"/>
</div>
</li>
<li class="w-100">
<div class="form-check form-check-reverse">
<label class="form-check-label" for="radio6">Chinese</label>
<input class="form-check-input" id="radio6" name="exampleRadios" type="radio" value="option6"/>
</div>
</li>
</ul>
</div>
...
`;function mi(){return(0,M.jsx)(N,{html:pi})}var hi=`fuzzy-remembered-email`,gi=`https://trungfuzzy-api.vercel.app/api`;function _i(){let e=_t(),t=k(),{login:n}=Ir(),[r,i]=(0,x.useState)(()=>localStorage.getItem(hi)??``),[a,o]=(0,x.useState)(``),[s,c]=(0,x.useState)(()=>!!localStorage.getItem(hi)),[l,u]=(0,x.useState)(``),[d,f]=(0,x.useState)(!1),[p,m]=(0,x.useState)(!1),h=t.state?.notice;(0,x.useEffect)(()=>(document.body.classList.add(`auth-body`),Tr(),()=>document.body.classList.remove(`auth-body`)),[]);async function g(i){if(i.preventDefault(),u(``),!r.trim()){u(`Please enter your email.`);return}if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(r)){u(`Please enter a valid email address.`);return}if(a.length<8){u(`Password must contain at least 8 characters.`);return}s?localStorage.setItem(hi,r.trim()):localStorage.removeItem(hi),m(!0);try{await n(r.trim(),a),e(t.state?.from??`/landing`,{replace:!0})}catch(e){u(e instanceof Error?e.message:`Login failed.`)}finally{m(!1)}}return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsxs)(`div`,{className:`auth-img`,children:[(0,M.jsx)(`img`,{alt:`A modern sofa in a dark interior`,className:`img-fluid auth-bg`,src:`/assets/images/background/auth_bg.jpg`}),(0,M.jsx)(`div`,{className:`auth-content`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{children:`Hello Again!`}),(0,M.jsx)(`h4`,{className:`p-0`,children:`Welcome back, You have been missed!`})]})})]}),(0,M.jsx)(`form`,{className:`auth-form`,noValidate:!0,onSubmit:g,children:(0,M.jsxs)(`div`,{className:`custom-container`,children:[(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{className:`form-label`,htmlFor:`inputusername`,children:`Email id`}),(0,M.jsxs)(`div`,{className:`form-input mb-4`,children:[(0,M.jsx)(`input`,{autoComplete:`email`,className:`form-control`,id:`inputusername`,onChange:e=>i(e.target.value),placeholder:`Enter Your Email`,type:`email`,value:r}),(0,M.jsx)(`i`,{className:`iconsax icons`,"data-icon":`mail`})]})]}),(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{className:`form-label`,htmlFor:`inputPassword`,children:`Password`}),(0,M.jsxs)(`div`,{className:`form-input`,children:[(0,M.jsx)(`input`,{autoComplete:`current-password`,className:`form-control`,id:`inputPassword`,onChange:e=>o(e.target.value),placeholder:`Enter Your Password`,type:d?`text`:`password`,value:a}),(0,M.jsx)(`i`,{className:`iconsax icons`,"data-icon":`key`}),(0,M.jsx)(`button`,{"aria-label":d?`Hide password`:`Show password`,className:`password-toggle`,onClick:()=>f(e=>!e),type:`button`,children:d?`Hide`:`Show`})]})]}),(0,M.jsxs)(`div`,{className:`option mt-3`,children:[(0,M.jsxs)(`div`,{className:`form-check`,children:[(0,M.jsx)(`input`,{checked:s,className:`form-check-input`,id:`flexCheckDefault`,onChange:e=>c(e.target.checked),type:`checkbox`}),(0,M.jsx)(`label`,{className:`form-check-label`,htmlFor:`flexCheckDefault`,children:`Remember me`})]}),(0,M.jsx)(j,{className:`forgot`,to:`/forgot-password`,children:`Forgot password?`})]}),h&&!l&&(0,M.jsx)(`p`,{className:`login-notice`,role:`status`,children:h}),l&&(0,M.jsx)(`p`,{className:`login-error`,role:`alert`,children:l}),(0,M.jsx)(`div`,{className:`submit-btn`,children:(0,M.jsx)(`button`,{className:`btn auth-btn w-100`,disabled:p,type:`submit`,children:p?`Signing in...`:`Sign In`})}),(0,M.jsx)(`div`,{className:`division`,children:(0,M.jsx)(`span`,{children:`OR`})}),(0,M.jsxs)(`ul`,{className:`social-media`,children:[(0,M.jsx)(`li`,{children:(0,M.jsx)(`a`,{"aria-label":`Sign in with Facebook`,href:`${gi}/auth/oauth/facebook`,children:(0,M.jsx)(`img`,{alt:``,className:`img-fluid icons`,src:`/assets/images/svg/facebook.svg`})})}),(0,M.jsx)(`li`,{children:(0,M.jsx)(`a`,{"aria-label":`Sign in with Google`,href:`${gi}/auth/oauth/google`,children:(0,M.jsx)(`img`,{alt:``,className:`img-fluid icons`,src:`/assets/images/svg/google.svg`})})}),(0,M.jsx)(`li`,{children:(0,M.jsx)(`a`,{"aria-label":`Sign in with Apple`,href:`https://appleid.apple.com/`,rel:`noreferrer`,target:`_blank`,children:(0,M.jsx)(`img`,{alt:``,className:`img-fluid icons`,src:`/assets/images/svg/apple.svg`})})})]}),(0,M.jsxs)(`h4`,{className:`signup`,children:[`Don't have an account? `,(0,M.jsx)(j,{to:`/create-account`,children:`Sign up`})]})]})})]})}function vi(){let{user:e,refreshUser:t}=Ir();if(!e)return null;async function n(e){await Nr(`/users/me/addresses/${e.id}`,{method:`PATCH`,body:JSON.stringify({...e,isDefault:!0})}),await t()}async function r(e){window.confirm(`Delete ${e.label} address?`)&&(await Nr(`/users/me/addresses/${e.id}`,{method:`DELETE`}),await t())}return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`header`,{className:`section-t-space`,children:(0,M.jsx)(`div`,{className:`custom-container`,children:(0,M.jsxs)(`div`,{className:`header-panel`,children:[(0,M.jsx)(j,{to:`/profile`,children:`â†`}),(0,M.jsx)(`h3`,{children:`Saved Address`})]})})}),(0,M.jsx)(`section`,{className:`shipping-details-sec`,children:(0,M.jsxs)(`div`,{className:`custom-container`,children:[!e.addresses.length&&(0,M.jsx)(`div`,{className:`empty-state`,children:`No saved addresses yet.`}),(0,M.jsx)(`ul`,{className:`address-list`,children:e.addresses.map(e=>(0,M.jsx)(`li`,{children:(0,M.jsxs)(`div`,{className:`shipping-address`,children:[(0,M.jsxs)(`div`,{className:`address-heading`,children:[(0,M.jsxs)(`label`,{children:[(0,M.jsx)(`input`,{checked:e.isDefault,name:`defaultAddress`,onChange:()=>n(e),type:`radio`}),(0,M.jsx)(`strong`,{children:e.label}),e.isDefault&&(0,M.jsx)(`small`,{children:`Default`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(j,{className:`address-action`,to:`/new-address?id=${e.id}`,children:`Edit`}),(0,M.jsx)(`button`,{className:`address-action danger`,onClick:()=>r(e),type:`button`,children:`Delete`})]})]}),(0,M.jsxs)(`div`,{className:`address-details`,children:[(0,M.jsxs)(`p`,{children:[e.recipientName,` Â· `,e.street,e.landmark?`, ${e.landmark}`:``,`, `,e.city,` `,e.postalCode]}),(0,M.jsxs)(`h5`,{children:[`Phone no.: `,(0,M.jsx)(`span`,{children:e.phone})]})]})]})},e.id))}),(0,M.jsx)(j,{className:`btn theme-btn w-100 add-address-button`,to:`/new-address`,children:`Add new address`})]})})]})}var yi=`html<html lang="en"><meta charset="utf-8"/><meta content="width=device-width,initial-scale=1" name="viewport"/><meta content="#000" name="theme-color"/><title>404: NOT_FOUND</title><style>html{font-size:62.5%;box-sizing:border-box;height:-webkit-fill-available}*,::after,::before{box-sizing:inherit}body{font-family:sf pro text,sf pro icons,helvetica neue,helvetica,arial,sans-serif;font-size:1.6rem;line-height:1.65;word-break:break-word;font-kerning:auto;font-variant:normal;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-rendering:optimizeLegibility;hyphens:auto;height:100vh;height:-webkit-fill-available;max-height:100vh;max-height:-webkit-fill-available;margin:0}::selection{background:#79ffe1}::-moz-selection{background:#79ffe1}a{cursor:pointer;color:#0070f3;text-decoration:none;transition:all .2s ease;border-bottom:1px solid #0000}a:hover{border-bottom:1px solid #0070f3}ul{padding:0;margin-left:1.5em;list-style-type:none}li{margin-bottom:10px}ul li:before{content:'\\02013'}li:before{display:inline-block;color:#ccc;position:absolute;margin-left:-18px;transition:color .2s ease}code{font-family:Menlo,Monaco,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New,monospace,serif;font-size:.92em}code:after,code:before{content:'\`'}.container{display:flex;justify-content:center;flex-direction:column;min-height:100%}main{max-width:80rem;padding:4rem 6rem;margin:auto}ul{margin-bottom:32px}.error-title{font-size:2rem;padding-left:22px;line-height:1.5;margin-bottom:24px}.error-title-guilty{border-left:2px solid #ed367f}.error-title-innocent{border-left:2px solid #59b89c}@media(max-width:500px){.owner-error{display:none}}main p{color:#333}.devinfo-container{border:1px solid #ddd;border-radius:4px;padding:2rem;display:flex;flex-direction:column;margin-bottom:32px}.error-code{margin:0;font-size:1.6rem;color:#000;margin-bottom:1.6rem}.devinfo-line{color:#333}.devinfo-line code,code,li{color:#000}.devinfo-line:not(:last-child){margin-bottom:8px}.docs-link,.contact-link{font-weight:500}header,footer,footer a{display:flex;justify-content:center;align-items:center}header,footer{min-height:100px;height:100px}header{border-bottom:1px solid #eaeaea}header h1{font-size:1.8rem;margin:0;font-weight:500}header p{font-size:1.3rem;margin:0;font-weight:500}.header-item{display:flex;padding:0 2rem;margin:2rem 0;text-decoration:line-through;color:#999}.header-item.active{color:#ff0080;text-decoration:none}.header-item.first{border-right:1px solid #eaeaea}.header-item-content{display:flex;flex-direction:column}.header-item-icon{margin-right:1rem;margin-top:.6rem}footer{border-top:1px solid #eaeaea}footer a{color:#000}footer a:hover{border-bottom-color:#0000}footer svg{margin-left:.8rem}.note{padding:8pt 16pt;border-radius:5px;border:1px solid #0070f3;font-size:14px;line-height:1.8;color:#0070f3}@media(max-width:500px){.devinfo-container .devinfo-line code{margin-top:.4rem}.devinfo-container .devinfo-line:not(:last-child){margin-bottom:1.6rem}.devinfo-container{margin-bottom:0}header{flex-direction:column;height:auto;min-height:auto;align-items:flex-start}.header-item.first{border-right:none;margin-bottom:0}main{padding:1rem 2rem}body{font-size:1.4rem;line-height:1.55}footer{display:none}.note{margin-top:16px}}</style><div class="container"><main><p class="devinfo-container"><span class="error-code"><strong>404</strong>: NOT_FOUND</span>
<span class="devinfo-line">Code: <code>NOT_FOUND</code></span>
<span class="devinfo-line">ID: <code>hkg1::95vdd-1782696041161-84dfcc1ec4be</code></span></p><a class="owner-error" href="https://vercel.com/docs/errors/NOT_FOUND"><div class="note">Read our documentation to learn more about this error.</div></a></main></div></html>`;function bi(){return(0,M.jsx)(N,{html:yi})}var xi=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<div class="custom-container">
<h2 class="fw-semibold theme-color">Your Card</h2>
...
<label class="form-label" for="one">
<img alt="mastercard" class="img-fluid img" src="/assets/images/icons/svg/mastercard.svg"/>
<span>
<span class="fw-normal theme-color card-heading">Mastercard *** *** 4589</span>
<span class="fw-normal card-sub-heading">Expires on 16/24</span>
</span>
</label>
<div class="form-check">
<input checked="" class="form-check-input" id="one" name="flexRadioDefault" type="radio"/>
</div>
</div>
</li>
<li class="cart-add-box payment-card-box gap-0 mt-3">
<div class="payment-detail border-bottom-0">
<label class="form-label" for="two">
<img alt="visa" class="img-fluid img" src="/assets/images/icons/svg/visa.svg"/>
<span>
<span class="fw-normal theme-color card-heading">visa *** *** 4589</span>
<span class="fw-normal card-sub-heading">Expires on 16/24</span>
</span>
</label>
<div class="form-check">
<input class="form-check-input" id="two" name="flexRadioDefault" type="radio"/>
</div>
</div>
</li>
</ul>
...
<h2 class="fw-semibold theme-color section-t-space">Wallet</h2>
<div class="payment-list">
<ul class="cart-add-box payment-card-box gap-0 mt-3">
<li class="w-100">
<div class="payment-detail">
<label class="form-label" for="three">
<img alt="mastercard" class="img-fluid img" src="/assets/images/icons/svg/paypal.svg"/>
<span>
<span class="fw-normal theme-color">Pay Pal</span>
</span>
</label>
<div class="form-check">
<input class="form-check-input" id="three" name="flexRadioDefault" type="radio"/>
</div>
</div>
</li>
<li class="w-100">
...
<img alt="apple-pay" class="img-fluid img1" src="/assets/images/icons/svg/apple-pay.svg"/>
<span>
<span class="fw-normal theme-color">Apple Pay</span>
</span>
</label>
<div class="form-check">
<input class="form-check-input" id="four" name="flexRadioDefault" type="radio"/>
</div>
</div>
</li>
<li class="w-100">
<div class="payment-detail">
<label class="form-label" for="five">
<img alt="google-pay" class="img-fluid img" src="/assets/images/icons/svg/google-pay.svg"/>
<span>
<span class="fw-normal theme-color">Google Pay</span>
</span>
</label>
<div class="form-check">
<input class="form-check-input" id="five" name="flexRadioDefault" type="radio"/>
</div>
</div>
</li>
<li class="w-100">
<div class="payment-detail border-bottom-0">
<label class="form-label" for="six">
<img alt="cash" class="img-fluid img" src="/assets/images/icons/svg/cash.svg"/>
<span>
<span class="fw-normal theme-color">Cash on Delivery</span>
</span>
</label>
<div class="form-check">
<input class="form-check-input" id="six" name="flexRadioDefault" type="radio"/>
</div>
</div>
</li>
</ul>
...
`;function Si(){return(0,M.jsx)(N,{html:xi})}var Ci=`html<html lang="en"><meta charset="utf-8"/><meta content="width=device-width,initial-scale=1" name="viewport"/><meta content="#000" name="theme-color"/><title>404: NOT_FOUND</title><style>html{font-size:62.5%;box-sizing:border-box;height:-webkit-fill-available}*,::after,::before{box-sizing:inherit}body{font-family:sf pro text,sf pro icons,helvetica neue,helvetica,arial,sans-serif;font-size:1.6rem;line-height:1.65;word-break:break-word;font-kerning:auto;font-variant:normal;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-rendering:optimizeLegibility;hyphens:auto;height:100vh;height:-webkit-fill-available;max-height:100vh;max-height:-webkit-fill-available;margin:0}::selection{background:#79ffe1}::-moz-selection{background:#79ffe1}a{cursor:pointer;color:#0070f3;text-decoration:none;transition:all .2s ease;border-bottom:1px solid #0000}a:hover{border-bottom:1px solid #0070f3}ul{padding:0;margin-left:1.5em;list-style-type:none}li{margin-bottom:10px}ul li:before{content:'\\02013'}li:before{display:inline-block;color:#ccc;position:absolute;margin-left:-18px;transition:color .2s ease}code{font-family:Menlo,Monaco,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New,monospace,serif;font-size:.92em}code:after,code:before{content:'\`'}.container{display:flex;justify-content:center;flex-direction:column;min-height:100%}main{max-width:80rem;padding:4rem 6rem;margin:auto}ul{margin-bottom:32px}.error-title{font-size:2rem;padding-left:22px;line-height:1.5;margin-bottom:24px}.error-title-guilty{border-left:2px solid #ed367f}.error-title-innocent{border-left:2px solid #59b89c}@media(max-width:500px){.owner-error{display:none}}main p{color:#333}.devinfo-container{border:1px solid #ddd;border-radius:4px;padding:2rem;display:flex;flex-direction:column;margin-bottom:32px}.error-code{margin:0;font-size:1.6rem;color:#000;margin-bottom:1.6rem}.devinfo-line{color:#333}.devinfo-line code,code,li{color:#000}.devinfo-line:not(:last-child){margin-bottom:8px}.docs-link,.contact-link{font-weight:500}header,footer,footer a{display:flex;justify-content:center;align-items:center}header,footer{min-height:100px;height:100px}header{border-bottom:1px solid #eaeaea}header h1{font-size:1.8rem;margin:0;font-weight:500}header p{font-size:1.3rem;margin:0;font-weight:500}.header-item{display:flex;padding:0 2rem;margin:2rem 0;text-decoration:line-through;color:#999}.header-item.active{color:#ff0080;text-decoration:none}.header-item.first{border-right:1px solid #eaeaea}.header-item-content{display:flex;flex-direction:column}.header-item-icon{margin-right:1rem;margin-top:.6rem}footer{border-top:1px solid #eaeaea}footer a{color:#000}footer a:hover{border-bottom-color:#0000}footer svg{margin-left:.8rem}.note{padding:8pt 16pt;border-radius:5px;border:1px solid #0070f3;font-size:14px;line-height:1.8;color:#0070f3}@media(max-width:500px){.devinfo-container .devinfo-line code{margin-top:.4rem}.devinfo-container .devinfo-line:not(:last-child){margin-bottom:1.6rem}.devinfo-container{margin-bottom:0}header{flex-direction:column;height:auto;min-height:auto;align-items:flex-start}.header-item.first{border-right:none;margin-bottom:0}main{padding:1rem 2rem}body{font-size:1.4rem;line-height:1.55}footer{display:none}.note{margin-top:16px}}</style><div class="container"><main><p class="devinfo-container"><span class="error-code"><strong>404</strong>: NOT_FOUND</span>
<span class="devinfo-line">Code: <code>NOT_FOUND</code></span>
<span class="devinfo-line">ID: <code>hkg1::6xdtt-1782696033706-9714261f08f6</code></span></p><a class="owner-error" href="https://vercel.com/docs/errors/NOT_FOUND"><div class="note">Read our documentation to learn more about this error.</div></a></main></div></html>`;function wi(){return(0,M.jsx)(N,{html:Ci})}var Ti={label:`Home`,recipientName:``,phone:``,street:``,landmark:``,city:``,postalCode:``,isDefault:!1};function Ei(){let{user:e,refreshUser:t}=Ir(),n=_t(),[r]=Wn(),i=r.get(`id`),a=(0,x.useMemo)(()=>e?.addresses.find(e=>e.id===i),[i,e]),[o,s]=(0,x.useState)(()=>a?{label:a.label,recipientName:a.recipientName,phone:a.phone,street:a.street,landmark:a.landmark,city:a.city,postalCode:a.postalCode,isDefault:a.isDefault}:Ti),[c,l]=(0,x.useState)(``),[u,d]=(0,x.useState)(!1);async function f(e){e.preventDefault(),l(``),d(!0);try{await Nr(i?`/users/me/addresses/${i}`:`/users/me/addresses`,{method:i?`PATCH`:`POST`,body:JSON.stringify(o)}),await t(),n(`/manage-address`)}catch(e){l(e instanceof Error?e.message:`Could not save address.`)}finally{d(!1)}}let p=(e,t)=>s(n=>({...n,[e]:t}));return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`header`,{className:`section-t-space`,children:(0,M.jsx)(`div`,{className:`custom-container`,children:(0,M.jsxs)(`div`,{className:`header-panel`,children:[(0,M.jsx)(j,{to:`/manage-address`,children:`â†`}),(0,M.jsx)(`h3`,{children:i?`Edit Address`:`Add New Address`})]})})}),(0,M.jsx)(`section`,{className:`section-b-space`,children:(0,M.jsx)(`div`,{className:`custom-container`,children:(0,M.jsxs)(`form`,{className:`address-form`,onSubmit:f,children:[(0,M.jsx)(`label`,{className:`form-label`,children:`Recipient name`}),(0,M.jsx)(`input`,{className:`form-control mb-3`,minLength:2,onChange:e=>p(`recipientName`,e.target.value),required:!0,value:o.recipientName}),(0,M.jsx)(`label`,{className:`form-label`,children:`Phone number`}),(0,M.jsx)(`input`,{className:`form-control mb-3`,onChange:e=>p(`phone`,e.target.value),pattern:`\\\\+?[0-9][0-9\\\\s-]{7,14}`,required:!0,value:o.phone}),(0,M.jsx)(`label`,{className:`form-label`,children:`Street address`}),(0,M.jsx)(`input`,{className:`form-control mb-3`,minLength:5,onChange:e=>p(`street`,e.target.value),required:!0,value:o.street}),(0,M.jsx)(`label`,{className:`form-label`,children:`Landmark`}),(0,M.jsx)(`input`,{className:`form-control mb-3`,onChange:e=>p(`landmark`,e.target.value),value:o.landmark}),(0,M.jsxs)(`div`,{className:`row`,children:[(0,M.jsxs)(`div`,{className:`col-6`,children:[(0,M.jsx)(`label`,{className:`form-label`,children:`City`}),(0,M.jsx)(`input`,{className:`form-control mb-3`,minLength:2,onChange:e=>p(`city`,e.target.value),required:!0,value:o.city})]}),(0,M.jsxs)(`div`,{className:`col-6`,children:[(0,M.jsx)(`label`,{className:`form-label`,children:`Postal code`}),(0,M.jsx)(`input`,{className:`form-control mb-3`,minLength:3,onChange:e=>p(`postalCode`,e.target.value),required:!0,value:o.postalCode})]})]}),(0,M.jsx)(`label`,{className:`form-label`,children:`Address type`}),(0,M.jsx)(`div`,{className:`address-type-options`,children:[`Home`,`Office`,`Other`].map(e=>(0,M.jsxs)(`label`,{children:[(0,M.jsx)(`input`,{checked:o.label===e,name:`label`,onChange:()=>p(`label`,e),type:`radio`}),` `,e]},e))}),(0,M.jsxs)(`label`,{className:`default-address-check`,children:[(0,M.jsx)(`input`,{checked:o.isDefault,onChange:e=>p(`isDefault`,e.target.checked),type:`checkbox`}),` Set as default address`]}),c&&(0,M.jsx)(`p`,{className:`form-message`,role:`alert`,children:c}),(0,M.jsxs)(`div`,{className:`footer-modal d-flex gap-3`,children:[(0,M.jsx)(j,{className:`btn gray-btn btn-inline mt-0 w-50`,to:`/manage-address`,children:`Cancel`}),(0,M.jsx)(`button`,{className:`theme-btn btn btn-inline mt-0 w-50`,disabled:u,type:`submit`,children:u?`Saving...`:`Save`})]})]})})})]})}var Di=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<div class="form-input mb-3">
<input class="form-control" placeholder="Enter card holder name" type="text"/>
</div>
</div>
<div class="row">
<div class="col-5">
...
<div class="form-input mb-3"><input class="form-control" placeholder="Enter cvv" type="password"/></div>
</div>
</div>
<div class="col-7">
<div class="form-group">
...
<a class="btn theme-btn mt-5 w-100" href="/payment">Add Card</a>
</form>
</div>
</section>
 card form section start 
...
`;function Oi(){return(0,M.jsx)(N,{html:Di})}var ki=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<div class="row g-3">
<div class="col-12">
<div class="notification-product-box">
<a class="notification-product-img" href="#">
<img alt="discount" class="img-fluid notification-icons" src="/assets/images/svg/discount.svg"/>
</a>
<div class="notification-product-details notification-details">
<div class="w-100">
...
<div class="col-12">
<div class="notification-product-box">
<a class="notification-product-img notification-img" href="#">
<img alt="wallet" class="img-fluid notification-icons" src="/assets/images/svg/wallet.svg"/>
</a>
<div class="notification-product-details notification-details">
<div class="w-100">
...
<div class="notification-product-box">
<a class="notification-product-img notification-img" href="#">
<img alt="location" class="img-fluid notification-icons" src="/assets/images/svg/location.svg"/>
</a>
<div class="notification-product-details notification-details">
<div class="w-100">
...
<div class="notification-product-box">
<a class="notification-product-img notification-img" href="#">
<img alt="card" class="img-fluid notification-icons" src="/assets/images/svg/card.svg"/>
</a>
<div class="notification-product-details notification-details">
<div class="w-100">
...
<div class="notification-product-box">
<a class="notification-product-img notification-img" href="#">
<img alt="profile" class="img-fluid notification-icons" src="/assets/images/svg/profile-fill.svg"/>
</a>
<div class="notification-product-details notification-details">
<div class="w-100">
...
`;function Ai(){return(0,M.jsx)(N,{html:ki})}var ji=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<div class="horizontal-product-box pb-0">
<a class="horizontal-product-img" href="#">
<img alt="p3" class="img-fluid img" src="/assets/images/product/3.png"/>
</a>
<div class="horizontal-product-details">
<div class="d-flex align-items-center justify-content-between gap-2">
<h4>Wingback Chair</h4>
<h3 class="fw-semibold">$112</h3>
</div>
<h5>Qty:1</h5>
</div>
</div>
...
<section class="section-t-space">
<div class="custom-container">
<div class="order-tracking mt-0">
<h2 class="mb-3">Order Journey</h2>
<ul>
<li class="order-process completed">
<div class="d-flex gap-3 w-100">
<span>
<img alt="check" class="process-icon" src="/assets/images/svg/chack.svg"/>
</span>
...
<section class="bill-details section-b-space">
<div class="custom-container">
<div class="total-detail">
<div class="sub-total d-flex justify-content-between">
<h5 class="light-text">Sub Total</h5>
<h4 class="fw-medium">$112</h4>
</div>
<div class="sub-total mt-3 d-flex justify-content-between">
<h5 class="light-text">Shipping charge</h5>
<h4 class="fw-medium">$20.00</h4>
</div>
<div class="sub-total mt-3 mb-3 d-flex justify-content-between">
<h5 class="fw-medium light-text">Discount (10%)</h5>
<h4 class="fw-medium">$0.00</h4>
</div>
<div class="grand-total pt-3 d-flex justify-content-between">
<h5 class="fw-medium">Grand Total</h5>
<h4 class="fw-semibold amount">$132</h4>
</div>
</div>
<a class="btn gray-btn invoice-btn w-100" href="/landing">Download Invoice</a>
</div>
</section>
 billing section start 
 iconsax js 
...
`;function Mi(){return(0,M.jsx)(N,{html:ji})}var Ni={pending:`Waiting confirmation`,preparing:`Preparing`,shipping:`Shipping`,completed:`Completed`,cancelled:`Cancelled`};function Pi(){let[e,t]=(0,x.useState)([]),[n,r]=(0,x.useState)(!0);return(0,x.useEffect)(()=>{Nr(`/orders`).then(e=>t(e.orders)).finally(()=>r(!1))},[]),(0,M.jsxs)(`div`,{className:`orders-page`,children:[(0,M.jsxs)(`header`,{className:`header-panel custom-container section-t-space`,children:[(0,M.jsx)(j,{to:`/profile`,children:`â†`}),(0,M.jsx)(`h3`,{children:`My Orders`})]}),(0,M.jsxs)(`main`,{className:`custom-container`,children:[n&&(0,M.jsx)(`div`,{className:`empty-state`,children:`Loading...`}),!n&&!e.length&&(0,M.jsx)(`div`,{className:`empty-state`,children:`No orders yet.`}),e.map(e=>(0,M.jsxs)(j,{className:`order-card`,to:`/order-tracking/${e.id}`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`strong`,{children:e.code}),(0,M.jsx)(`span`,{className:`order-status ${e.status}`,children:Ni[e.status]})]}),(0,M.jsxs)(`p`,{children:[e.items.length,` items Â· `,new Date(e.createdAt).toLocaleDateString()]}),(0,M.jsxs)(`b`,{children:[`$`,e.total.toFixed(2)]})]},e.id))]})]})}var Fi=[{status:`pending`,title:`Waiting confirmation`},{status:`preparing`,title:`Preparing order`},{status:`shipping`,title:`Out for delivery`},{status:`completed`,title:`Delivered`}];function Ii(){let{orderId:e}=yt(),[t,n]=(0,x.useState)(null),[r,i]=(0,x.useState)(``);if((0,x.useEffect)(()=>{e&&Nr(`/orders/${e}`).then(e=>n(e.order)).catch(e=>i(e.message))},[e]),!t)return(0,M.jsx)(`div`,{className:`auth-loading`,children:r||`Loading order...`});let a=Fi.findIndex(e=>e.status===t.status);return(0,M.jsxs)(`div`,{className:`tracking-page`,children:[(0,M.jsxs)(`header`,{className:`header-panel custom-container section-t-space`,children:[(0,M.jsx)(j,{to:`/order-history`,children:`â†`}),(0,M.jsx)(`h3`,{children:`Track Order`})]}),(0,M.jsxs)(`main`,{className:`custom-container`,children:[(0,M.jsxs)(`section`,{className:`tracking-summary`,children:[(0,M.jsx)(`p`,{children:`Order code`}),(0,M.jsx)(`h2`,{children:t.code}),(0,M.jsx)(`span`,{children:new Date(t.createdAt).toLocaleString()})]}),t.status===`cancelled`?(0,M.jsx)(`div`,{className:`cancelled-banner`,children:`Order cancelled`}):(0,M.jsx)(`ol`,{className:`order-timeline`,children:Fi.map((e,n)=>{let r=t.statusHistory.find(t=>t.status===e.status);return(0,M.jsxs)(`li`,{className:n<=a?`done`:``,children:[(0,M.jsx)(`i`,{}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`strong`,{children:e.title}),(0,M.jsx)(`p`,{children:r?.note??`Waiting for update`}),r&&(0,M.jsx)(`small`,{children:new Date(r.at).toLocaleString()})]})]},e.status)})}),(0,M.jsx)(`section`,{className:`tracking-items`,children:t.items.map(e=>(0,M.jsxs)(`article`,{children:[(0,M.jsx)(`img`,{src:e.image}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`strong`,{children:e.name}),(0,M.jsxs)(`p`,{children:[e.size,` Â· Qty `,e.quantity]})]}),(0,M.jsxs)(`b`,{children:[`$`,(e.price*e.quantity).toFixed(2)]})]},`${e.productId}-${e.color}-${e.size}`))}),(0,M.jsxs)(`section`,{className:`tracking-address`,children:[(0,M.jsx)(`h3`,{children:`Delivery address`}),(0,M.jsxs)(`p`,{children:[t.shippingAddress.recipientName,`, `,t.shippingAddress.street,`, `,t.shippingAddress.city]}),(0,M.jsx)(`span`,{children:t.shippingAddress.phone})]})]})]})}var Li=`html<html lang="en"><meta charset="utf-8"/><meta content="width=device-width,initial-scale=1" name="viewport"/><meta content="#000" name="theme-color"/><title>404: NOT_FOUND</title><style>html{font-size:62.5%;box-sizing:border-box;height:-webkit-fill-available}*,::after,::before{box-sizing:inherit}body{font-family:sf pro text,sf pro icons,helvetica neue,helvetica,arial,sans-serif;font-size:1.6rem;line-height:1.65;word-break:break-word;font-kerning:auto;font-variant:normal;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-rendering:optimizeLegibility;hyphens:auto;height:100vh;height:-webkit-fill-available;max-height:100vh;max-height:-webkit-fill-available;margin:0}::selection{background:#79ffe1}::-moz-selection{background:#79ffe1}a{cursor:pointer;color:#0070f3;text-decoration:none;transition:all .2s ease;border-bottom:1px solid #0000}a:hover{border-bottom:1px solid #0070f3}ul{padding:0;margin-left:1.5em;list-style-type:none}li{margin-bottom:10px}ul li:before{content:'\\02013'}li:before{display:inline-block;color:#ccc;position:absolute;margin-left:-18px;transition:color .2s ease}code{font-family:Menlo,Monaco,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New,monospace,serif;font-size:.92em}code:after,code:before{content:'\`'}.container{display:flex;justify-content:center;flex-direction:column;min-height:100%}main{max-width:80rem;padding:4rem 6rem;margin:auto}ul{margin-bottom:32px}.error-title{font-size:2rem;padding-left:22px;line-height:1.5;margin-bottom:24px}.error-title-guilty{border-left:2px solid #ed367f}.error-title-innocent{border-left:2px solid #59b89c}@media(max-width:500px){.owner-error{display:none}}main p{color:#333}.devinfo-container{border:1px solid #ddd;border-radius:4px;padding:2rem;display:flex;flex-direction:column;margin-bottom:32px}.error-code{margin:0;font-size:1.6rem;color:#000;margin-bottom:1.6rem}.devinfo-line{color:#333}.devinfo-line code,code,li{color:#000}.devinfo-line:not(:last-child){margin-bottom:8px}.docs-link,.contact-link{font-weight:500}header,footer,footer a{display:flex;justify-content:center;align-items:center}header,footer{min-height:100px;height:100px}header{border-bottom:1px solid #eaeaea}header h1{font-size:1.8rem;margin:0;font-weight:500}header p{font-size:1.3rem;margin:0;font-weight:500}.header-item{display:flex;padding:0 2rem;margin:2rem 0;text-decoration:line-through;color:#999}.header-item.active{color:#ff0080;text-decoration:none}.header-item.first{border-right:1px solid #eaeaea}.header-item-content{display:flex;flex-direction:column}.header-item-icon{margin-right:1rem;margin-top:.6rem}footer{border-top:1px solid #eaeaea}footer a{color:#000}footer a:hover{border-bottom-color:#0000}footer svg{margin-left:.8rem}.note{padding:8pt 16pt;border-radius:5px;border:1px solid #0070f3;font-size:14px;line-height:1.8;color:#0070f3}@media(max-width:500px){.devinfo-container .devinfo-line code{margin-top:.4rem}.devinfo-container .devinfo-line:not(:last-child){margin-bottom:1.6rem}.devinfo-container{margin-bottom:0}header{flex-direction:column;height:auto;min-height:auto;align-items:flex-start}.header-item.first{border-right:none;margin-bottom:0}main{padding:1rem 2rem}body{font-size:1.4rem;line-height:1.55}footer{display:none}.note{margin-top:16px}}</style><div class="container"><main><p class="devinfo-container"><span class="error-code"><strong>404</strong>: NOT_FOUND</span>
<span class="devinfo-line">Code: <code>NOT_FOUND</code></span>
<span class="devinfo-line">ID: <code>hkg1::8b4kc-1782696042858-992cf1217cdd</code></span></p><a class="owner-error" href="https://vercel.com/docs/errors/NOT_FOUND"><div class="note">Read our documentation to learn more about this error.</div></a></main></div></html>`;function Ri(){return(0,M.jsx)(N,{html:Li})}var P=`
 otp section start 
<div class="auth-img">
<img alt="auth_bg" class="img-fluid auth-bg" src="/assets/images/background/auth_bg.jpg"/>
<div class="auth-content">
...
<h4 class="otp-number mt-2">+91 635 546 23098</h4>
</div>
<form class="otp-form">
<div class="form-input dark-border-gradient">
<input class="form-control active" id="five1" onfocus="onFocusEvent(1)" onkeyup="onKeyUpEvent(1, event)" placeholder="0" type="number"/>
</div>
<div class="form-input dark-border-gradient">
<input class="form-control" id="five2" onfocus="onFocusEvent(2)" onkeyup="onKeyUpEvent(2, event)" placeholder="0" type="number"/>
</div>
<div class="form-input dark-border-gradient">
<input class="form-control" id="five3" onfocus="onFocusEvent(3)" onkeyup="onKeyUpEvent(3, event)" placeholder="0" type="number"/>
</div>
<div class="form-input dark-border-gradient">
<input class="form-control" id="five4" onfocus="onFocusEvent(4)" onkeyup="onKeyUpEvent(4, event)" placeholder="0" type="number"/>
</div>
<div class="form-input dark-border-gradient">
<input class="form-control" id="five5" onfocus="onFocusEvent(5)" onkeyup="onKeyUpEvent(5, event)" placeholder="0" type="number"/>
</div>
</form>
<a class="btn auth-btn w-100" href="/reset-password" role="button">Verify</a>
</div>
 otp section end 
 otp js 
...
`;function F(){return(0,M.jsx)(N,{html:P})}var zi=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<div class="custom-container">
<div class="categories-title pb-2">
<h2>Onboarding &amp; Authentication</h2>
</div>
<div class="categories-menu">
<ul class="navigation">
<li class="pages">
<a href="/create-account">create Account<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/ne">Forgot Password<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/login">Login<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/">Onboarding<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/otp">Otp<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/reset-password">Reset Password<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
</ul>
</div>
<div class="categories-title pb-2">
...
<ul class="navigation">
<li class="pages">
<a href="/categories">Categories<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/landing">Home Page<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/product-details">Product Details Page<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/product2-details">Product-2 Details Page<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/shop">Shop page<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
</ul>
</div>
<div class="categories-title pb-2">
...
<ul class="navigation">
<li class="pages">
<a href="/cart">cart<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/checkout">checkout<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/coupon">Coupon<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/new-address">New Address<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/new-card">New card<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/order-details">Order details<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/order-tracking">Order-tracking<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/payment">Payment<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/shipping-address">Shipping Address<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/shipping">Shipping Page<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
</ul>
</div>
<div class="categories-title pb-2">
...
<ul class="navigation">
<li class="pages">
<a href="/help">Help<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/language">Language<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/manage-delivery-address">Manage-delivery-address<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/manage-payment">Manage payment<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/notification">Notification<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/order-history">Order history<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/other-setting">Other setting<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/profile">Profile<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/profile-setting">Profile setting<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/setting">Setting<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/terms-conditions">Terms &amp; Conditions Page<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/voucher">Voucher<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/wishlist">Wishlist<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
</ul>
</div>
<div class="categories-title pb-2">
...
<ul class="navigation">
<li class="pages">
<a href="/empty-cart">Empty cart<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/empty-notification">Empty Notification<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/empty-order-history">Empty Order History<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/empty-search">Empty Search<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/empty-wishlist">Empty Wishlist<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/page-listing">Page-Listing<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
<li class="pages">
<a href="/search">Search<i class="iconsax" data-icon="chevron-right"></i></a>
</li>
</ul>
</div>
</div>
...
`;function Bi(){return(0,M.jsx)(N,{html:zi})}var Vi=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<a class="btn btn-lg theme-btn pay-btn mt-0" data-bs-toggle="modal" href="#success">Pay Now</a>
</div>
 pay popup end 
...
<img alt="success-payment" class="img-fluid confirm-offer" src="/assets/images/gif/success.gif"/>
<h2 class="theme-color text-center fw-medium mt-2">Congratulations !!</h2>
<h5 class="light-text fw-normal lh-base text-center w-100 mt-2 mx-auto">Your order is accepted. Your items are on the way and should arrive shortly.</h5>
</div>
<a class="btn theme-btn w-100 mt-4" href="/order-tracking" role="button">Track Order Now</a>
<a class="btn gray-btn mt-3" href="/landing">Continue Shopping</a>
</div>
</div>
</div>
</div>
...
`;function Hi(){return(0,M.jsx)(N,{html:Vi})}var Ui=`https://trungfuzzy-api.vercel.app/api`;function Wi(){let{productId:e=`product-1`}=yt(),[t,n]=(0,x.useState)(null),[r,i]=(0,x.useState)(0),[a,o]=(0,x.useState)(``),[s,c]=(0,x.useState)(``),[l,u]=(0,x.useState)(1),[d,f]=(0,x.useState)(``),[p,m]=(0,x.useState)(!1);if((0,x.useEffect)(()=>{fetch(`${Ui}/products/${e}`).then(e=>{if(!e.ok)throw Error();return e.json()}).then(({product:e})=>{n(e),o(e.colors[0]??``),c(e.sizes[0]??``),m(ci(e.id))}).catch(()=>f(`Product not found.`))},[e]),!t)return(0,M.jsx)(`div`,{className:`auth-loading`,children:d||`Loading product...`});function h(){br({product:t,color:a,size:s,quantity:l}),f(`Added to cart!`),window.setTimeout(()=>f(``),1800)}return(0,M.jsxs)(`div`,{className:`mobile-product-detail`,children:[(0,M.jsxs)(`header`,{children:[(0,M.jsx)(j,{to:`/shop`,children:`â†`}),(0,M.jsx)(`h3`,{children:t.categoryId}),(0,M.jsxs)(`div`,{className:`detail-header-actions`,children:[(0,M.jsx)(`button`,{"aria-label":`Toggle wishlist`,className:p?`active`:``,onClick:()=>m(li(t)),children:p?`â™¥`:`â™¡`}),(0,M.jsx)(j,{to:`/cart`,children:`Bag`})]})]}),(0,M.jsxs)(`section`,{className:`detail-carousel`,children:[(0,M.jsx)(`img`,{alt:t.name,src:t.images[r]}),(0,M.jsx)(`button`,{disabled:r===0,onClick:()=>i(e=>e-1),children:`â€¹`}),(0,M.jsx)(`button`,{disabled:r===t.images.length-1,onClick:()=>i(e=>e+1),children:`â€º`}),(0,M.jsx)(`div`,{children:t.images.map((e,t)=>(0,M.jsx)(`i`,{className:t===r?`active`:``},t))})]}),(0,M.jsxs)(`main`,{className:`custom-container detail-content`,children:[(0,M.jsxs)(`div`,{className:`detail-title`,children:[(0,M.jsx)(`h1`,{children:t.name}),(0,M.jsxs)(`span`,{children:[`â˜… `,t.rating.toFixed(1)]})]}),(0,M.jsxs)(`div`,{className:`detail-price`,children:[`$`,t.price.toFixed(2),` `,(0,M.jsxs)(`del`,{children:[`$`,t.compareAtPrice.toFixed(2)]})]}),(0,M.jsx)(`p`,{children:t.description}),(0,M.jsx)(`h4`,{children:`Color`}),(0,M.jsx)(`div`,{className:`variant-colors`,children:t.colors.map(e=>(0,M.jsx)(`button`,{"aria-label":e,className:a===e?`active`:``,onClick:()=>o(e),style:{backgroundColor:e}},e))}),(0,M.jsx)(`h4`,{children:`Size`}),(0,M.jsx)(`div`,{className:`variant-sizes`,children:t.sizes.map(e=>(0,M.jsx)(`button`,{className:s===e?`active`:``,onClick:()=>c(e),children:e},e))}),(0,M.jsxs)(`div`,{className:`stock-line`,children:[(0,M.jsx)(`span`,{children:t.stock>0?`${t.stock} in stock`:`Out of stock`}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`button`,{onClick:()=>u(Math.max(1,l-1)),children:`âˆ’`}),(0,M.jsx)(`b`,{children:l}),(0,M.jsx)(`button`,{onClick:()=>u(Math.min(t.stock,l+1)),children:`+`})]})]})]}),(0,M.jsxs)(`div`,{className:`sticky-cart-bar`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`small`,{children:`Total`}),(0,M.jsxs)(`strong`,{children:[`$`,(t.price*l).toFixed(2)]})]}),(0,M.jsx)(`button`,{disabled:!t.stock,onClick:h,children:d||`Add to cart`})]})]})}var Gi=`
 header start 
...
<img alt="product-bg" class="img-fluid product2-bg" src="/assets/images/background/product-img-bg.png"/>
<div class="swiper product-2">
<div class="swiper-wrapper">
<div class="swiper-slide">
<img alt="p26" class="img-fluid product-img" src="/assets/images/product/29.png"/>
</div>
<div class="swiper-slide swiper-slide-active">
<img alt="p27" class="img-fluid product-img active" src="/assets/images/product/28.png"/>
</div>
<div class="swiper-slide">
<img alt="p26" class="img-fluid product-img" src="/assets/images/product/30.png"/>
</div>
</div>
...
<img alt="effect" class="img-fluid product-details-effect" src="/assets/images/effect.png"/>
<img alt="effect-dark" class="img-fluid product-details-effect-dark" src="/assets/images/effect-dark.png"/>
...
<h2 class="theme-color">Buddy Chair</h2>
<h6>20% OFF</h6>
</div>
...
<div class="d-block">
<i class="iconsax dimensions-icons icon1" data-icon="ruler"></i>
<h6>115 cm</h6>
</div>
</div>
<div class="dimensions-box">
<div class="d-block">
<i class="iconsax dimensions-icons" data-icon="ruler"></i>
<h6>115 cm</h6>
</div>
</div>
<div class="dimensions-box">
<div class="d-block">
<i class="iconsax dimensions-icons" data-icon="measure"></i>
<h6>115 cm</h6>
</div>
</div>
<div class="dimensions-box">
<div class="d-block">
<i class="iconsax dimensions-icons" data-icon="weights"></i>
<h6>115 cm</h6>
</div>
</div>
</div>
...
<button class="btn theme-btn" id="button-addon2" type="button">Check</button>
</div>
<div class="d-flex justify-content-between gap-3">
<div class="dimensions-box delivery-box">
<div class="d-block">
<i class="iconsax dimensions-icons" data-icon="truck-fast"></i>
<h6>Free Delivery</h6>
</div>
</div>
<div class="dimensions-box delivery-box">
<div class="d-block">
<i class="iconsax dimensions-icons" data-icon="dollar-circle"></i>
<h6>Cash On Delivery</h6>
</div>
</div>
<div class="dimensions-box delivery-box">
<div class="d-block">
<i class="iconsax dimensions-icons" data-icon="box-rotate"></i>
...
<p class="theme-color fw-normal mt-1">This product is eligible for returns and size replacements from the 'My Orders' section. <span class="theme-color fw-medium">... Read More</span></p>
</div>
</section>
 details section end 
...
<h2 class="theme-color">5.0</h2>
<ul class="rating-stars mt-1">
<li><img alt="star" class="img-fluid stars" src="/assets/images/svg/Star.svg"/></li>
<li><img alt="star" class="img-fluid stars" src="/assets/images/svg/Star.svg"/></li>
<li><img alt="star" class="img-fluid stars" src="/assets/images/svg/Star.svg"/></li>
<li><img alt="star" class="img-fluid stars" src="/assets/images/svg/Star.svg"/></li>
<li><img alt="star" class="img-fluid stars" src="/assets/images/svg/Star.svg"/></li>
</ul>
<h6 class="light-text text-center lh-base fw-normal mt-2">25,586 Rating \\ <span class="theme-color fw-normal">430 Reviews</span></h6>
</div>
<ul class="progress-main">
<li>
<span>5</span>
<img alt="star" class="img-fluid stars" src="/assets/images/svg/Star.svg"/>
...
<a class="my-review" data-bs-toggle="offcanvas" href="#my-review" role="button">+ Write Your Review</a>
</div>
</section>
 review section end 
...
<div class="product-box">
<div class="product-box-img">
<a href="/product-details"> <img alt="p1" class="img" src="/assets/images/product/1.png"/></a>
<div class="cart-box">
<a class="cart-bag" href="/cart">
<i class="iconsax bag" data-icon="basket-2"></i>
</a>
...
<div class="product-box">
<div class="product-box-img">
<a href="/product-details"> <img alt="p2" class="img" src="/assets/images/product/2.png"/></a>
<div class="cart-box">
<a class="cart-bag" href="/cart">
<i class="iconsax bag" data-icon="basket-2"></i>
</a>
...
<div class="product-box">
<div class="product-box-img">
<a href="/product-details"> <img alt="p14" class="img" src="/assets/images/product/14.png"/></a>
<div class="cart-box">
<a class="cart-bag" href="/cart">
<i class="iconsax bag" data-icon="basket-2"></i>
</a>
...
<div class="product-box">
<div class="product-box-img">
<a href="/product-details"> <img alt="p15" class="img" src="/assets/images/product/15.png"/></a>
<div class="cart-box">
<a class="cart-bag" href="/cart">
<i class="iconsax bag" data-icon="basket-2"></i>
</a>
...
<div class="product-box">
<div class="product-box-img">
<a href="/product-details"> <img alt="p16" class="img" src="/assets/images/product/16.png"/></a>
<div class="cart-box">
<a class="cart-bag" href="/cart">
<i class="iconsax bag" data-icon="basket-2"></i>
</a>
...
<img alt="p17" class="img" src="/assets/images/product/17.png"/>
</a>
<div class="cart-box">
<a class="cart-bag" href="/cart">
<i class="iconsax bag" data-icon="basket-2"></i>
...
<div class="offcanvas offcanvas-bottom my-review-offcanvas" id="my-review" tabindex="-1">
...
<li><img alt="star" class="img-fluid stars" src="/assets/images/svg/Star.svg"/></li>
<li><img alt="star" class="img-fluid stars" src="/assets/images/svg/Star.svg"/></li>
<li><img alt="star" class="img-fluid stars" src="/assets/images/svg/star1.svg"/></li>
</ul>
</div>
...
<input class="form-control" id="review" placeholder="Enter your Review Subjects" required="" type="text"/>
</div>
</div>
<div class="col-md-12">
<div class="form-group mt-3">
...
<div class="my-dropzone" id="upload-file"></div>
...
<textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Write Your Review Here" rows="3"></textarea>
</div>
</div>
<div class="col-md-12">
<a class="btn theme-btn mt-3" href="/product-details">Submit Your Review</a>
</div>
</div>
</form>
</div>
...
<div class="custom-container">
<a class="cart-box-sec" href="/cart">
<div class="d-flex align-items-center gap-2">
<i class="iconsax bag" data-icon="basket-2"></i>
<h2>Add to cart</h2>
</div>
...
`;function Ki(){return(0,M.jsx)(N,{html:Gi})}function qi(){let{user:e,setUser:t}=Ir(),n=_t(),[r,i]=(0,x.useState)(()=>({fullName:e?.fullName??``,phone:e?.phone??``,birthDate:e?.birthDate??``,avatar:e?.avatar??``})),[a,o]=(0,x.useState)(``),[s,c]=(0,x.useState)(!1);if(!e)return null;function l(e){let t=e.target.files?.[0];if(!t)return;if(!t.type.startsWith(`image/`)||t.size>15e5){o(`Avatar must be an image smaller than 1.5 MB.`);return}let n=new FileReader;n.onload=()=>i(e=>({...e,avatar:String(n.result)})),n.readAsDataURL(t)}async function u(e){e.preventDefault(),o(``),c(!0);try{t((await Nr(`/users/me`,{method:`PATCH`,body:JSON.stringify(r)})).user),n(`/profile`)}catch(e){o(e instanceof Error?e.message:`Could not save profile.`)}finally{c(!1)}}return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`header`,{className:`profile-header section-t-space`,children:(0,M.jsxs)(`div`,{className:`custom-container`,children:[(0,M.jsxs)(`div`,{className:`header-panel`,children:[(0,M.jsx)(j,{to:`/profile`,children:`â†`}),(0,M.jsx)(`h3`,{children:`Edit Profile`})]}),(0,M.jsxs)(`label`,{className:`profile-setting-pic mx-auto avatar-picker`,children:[(0,M.jsx)(`img`,{alt:``,className:`img-fluid img`,src:r.avatar||`/assets/images/icons/profile1.png`}),(0,M.jsx)(`input`,{accept:`image/*`,onChange:l,type:`file`}),(0,M.jsx)(`span`,{children:`Change`})]})]})}),(0,M.jsx)(`form`,{className:`theme-form profile-setting mt-4`,onSubmit:u,children:(0,M.jsxs)(`div`,{className:`custom-container`,children:[(0,M.jsx)(`label`,{className:`form-label`,htmlFor:`profileName`,children:`Full name`}),(0,M.jsx)(`input`,{className:`form-control mb-3`,id:`profileName`,minLength:2,onChange:e=>i({...r,fullName:e.target.value}),required:!0,value:r.fullName}),(0,M.jsx)(`label`,{className:`form-label`,htmlFor:`profileEmail`,children:`Email`}),(0,M.jsx)(`input`,{className:`form-control mb-3`,disabled:!0,id:`profileEmail`,value:e.email}),(0,M.jsx)(`label`,{className:`form-label`,htmlFor:`profilePhone`,children:`Phone number`}),(0,M.jsx)(`input`,{className:`form-control mb-3`,id:`profilePhone`,onChange:e=>i({...r,phone:e.target.value}),pattern:`\\\\+?[0-9][0-9\\\\s-]{7,14}`,value:r.phone}),(0,M.jsx)(`label`,{className:`form-label`,htmlFor:`birthDate`,children:`Birth date`}),(0,M.jsx)(`input`,{className:`form-control`,id:`birthDate`,max:new Date().toISOString().slice(0,10),onChange:e=>i({...r,birthDate:e.target.value}),type:`date`,value:r.birthDate}),a&&(0,M.jsx)(`p`,{className:`form-message`,role:`alert`,children:a}),(0,M.jsxs)(`div`,{className:`footer-modal d-flex gap-3`,children:[(0,M.jsx)(j,{className:`btn gray-btn btn-inline mt-0 w-50`,to:`/profile`,children:`Cancel`}),(0,M.jsx)(`button`,{className:`theme-btn btn btn-inline mt-0 w-50`,disabled:s,type:`submit`,children:s?`Saving...`:`Save`})]})]})})]})}function Ji(){let{user:e,logout:t}=Ir(),n=_t();return e?(0,M.jsxs)(`div`,{className:`account-page`,children:[(0,M.jsx)(`header`,{className:`profile-header section-t-space`,children:(0,M.jsxs)(`div`,{className:`custom-container`,children:[(0,M.jsxs)(`div`,{className:`header-panel`,children:[(0,M.jsx)(j,{to:`/landing`,children:`â†`}),(0,M.jsx)(`h3`,{children:`My Profile`})]}),(0,M.jsx)(`div`,{className:`profile-setting-pic mx-auto`,children:(0,M.jsx)(`img`,{alt:e.fullName,className:`img-fluid img`,src:e.avatar||`/assets/images/icons/profile1.png`})}),(0,M.jsxs)(`div`,{className:`profile-summary`,children:[(0,M.jsx)(`h2`,{children:e.fullName}),(0,M.jsx)(`p`,{children:e.email})]})]})}),(0,M.jsxs)(`main`,{className:`custom-container account-menu`,children:[(e.role===`admin`||!1)&&(0,M.jsxs)(j,{className:`admin-profile-link`,to:`/admin/users`,children:[(0,M.jsx)(`span`,{children:`Admin dashboard`}),(0,M.jsx)(`b`,{children:`â€º`})]}),(0,M.jsxs)(j,{to:`/profile-setting`,children:[(0,M.jsx)(`span`,{children:`Personal information`}),(0,M.jsx)(`b`,{children:`â€º`})]}),(0,M.jsxs)(j,{to:`/manage-address`,children:[(0,M.jsxs)(`span`,{children:[`Saved addresses (`,e.addresses.length,`)`]}),(0,M.jsx)(`b`,{children:`â€º`})]}),(0,M.jsxs)(j,{to:`/order-history`,children:[(0,M.jsx)(`span`,{children:`My orders`}),(0,M.jsx)(`b`,{children:`â€º`})]}),(0,M.jsxs)(`button`,{onClick:()=>{t(),n(`/login`,{replace:!0})},type:`button`,children:[(0,M.jsx)(`span`,{children:`Logout`}),(0,M.jsx)(`b`,{children:`â€º`})]})]})]}):null}var Yi=`
 login section start 
<div class="auth-img">
<img alt="auth_bg" class="img-fluid auth-bg" src="/assets/images/background/auth_bg.jpg"/>
<div class="auth-content">
...
<div class="form-input">
<input class="form-control" id="inputPassword1" placeholder="Enter New Password" type="password"/>
...
<div class="form-input">
<input class="form-control" id="inputPassword2" placeholder="Enter Confirm Password" type="password"/>
<i class="iconsax icons" data-icon="key"></i>
</div>
</div>
<a class="btn auth-btn w-100" href="/login" role="button">Reset Password</a>
</div>
</form>
 login section end
 iconsax js 
...
`;function Xi(){return(0,M.jsx)(N,{html:Yi})}var Zi=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
`;function Qi(){return(0,M.jsx)(N,{html:Zi})}var $i=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<h5 class="fw-semibold theme-color">Dark/Light</h5>
<div class="switch-btn">
<input id="dark-switch" type="checkbox"/>
</div>
</div>
...
<h5 class="fw-semibold theme-color">RTL</h5>
<div class="switch-btn">
<input id="dir-switch" type="checkbox"/>
</div>
</div>
...
<h5 class="fw-semibold theme-color">Notification</h5>
<div class="switch-btn">
<input type="checkbox"/>
</div>
</div>
...
`;function ea(){return(0,M.jsx)(N,{html:$i})}var ta=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<section class="shipping-details-sec">
<div class="custom-container">
...
<div class="d-flex align-items-center justify-content-between">
<div class="form-check">
<input checked="" class="form-check-input" id="radio1" name="flexRadio1" type="radio"/>
<label class="form-check-label" for="radio1">Home</label>
</div>
<div class="options">
<a href="/new-address">
<i class="iconsax icons" data-icon="edit-2"></i>
</a>
<a href="#">
<i class="iconsax icons" data-icon="trash"></i>
</a>
</div>
</div>
<div class="address-details">
<p>3501 Maloy Court, East Emhurst, New York City, NY 11369</p>
<h5 class="content-number">Phone no. : <span> 78596 0000</span></h5>
</div>
</div>
</li>
<li>
...
<div class="d-flex align-items-center justify-content-between">
<div class="form-check">
<input class="form-check-input" id="radio2" name="flexRadio1" type="radio"/>
...
<h5 class="content-number">Phone no. : <span> 12100 0023</span></h5>
</div>
</div>
</li>
</ul>
<a class="btn gray-btn w-100" href="/new-address">+ Add New Address</a>
<div class="apply-btn">
<a class="btn theme-btn w-100" href="/payment">apply</a>
</div>
</div>
</section>
...
`;function na(){return(0,M.jsx)(N,{html:ta})}var ra=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<input class="form-check-input" id="radio1" name="exampleRadio" type="radio" value="option2"/>
</div>
</div>
</div>
</div>
...
<div class="shipping-box">
<a href="#">
<i class="iconsax icons" data-icon="package"></i>
</a>
<div class="shipping-details">
<div class="shipping-info">
<h4>Regular</h4>
...
<input checked="" class="form-check-input" id="radio2" name="exampleRadio" type="radio" value="option2"/>
</div>
</div>
</div>
</div>
...
<div class="shipping-box">
<a href="#">
<i class="iconsax icons" data-icon="truck"></i>
</a>
<div class="shipping-details">
<div class="shipping-info">
<h4>Cargo</h4>
...
<div class="price">
<div class="form-check form-check-reverse">
<label class="form-check-label" for="radio3">$20</label>
<input class="form-check-input" id="radio3" name="exampleRadio" type="radio" value="option3"/>
</div>
</div>
</div>
</div>
...
<div class="shipping-box">
<a href="#">
<i class="iconsax icons" data-icon="truck-fast"></i>
</a>
<div class="shipping-details">
<div class="shipping-info">
<h4>Express</h4>
...
<div class="price">
<div class="form-check form-check-reverse">
<label class="form-check-label" for="radio4">$30</label>
<input class="form-check-input" id="radio4" name="exampleRadio" type="radio" value="option2"/>
</div>
</div>
</div>
</div>
...
<a class="btn theme-btn w-100 shipping" href="/checkout">apply</a>
</div>
</section>
...
`;function ia(){return(0,M.jsx)(N,{html:ra})}var aa=`https://trungfuzzy-api.vercel.app/api`;function oa(){let[e,t]=(0,x.useState)([]),[n,r]=(0,x.useState)([]),[i,a]=(0,x.useState)(0),[o,s]=(0,x.useState)(!1),[c,l]=(0,x.useState)(!1),[u,d]=(0,x.useState)(`grid`),[f,p]=(0,x.useState)(``),[m,h]=(0,x.useState)(()=>new Set(oi().map(e=>e.id))),[g,_]=(0,x.useState)({search:``,category:``,sort:`newest`,minPrice:``,maxPrice:``,color:``,size:``}),v=(0,x.useRef)(null);(0,x.useEffect)(()=>{fetch(`${aa}/categories`).then(e=>e.json()).then(e=>r(e.categories))},[]);let y=(0,x.useCallback)(async(e=!1)=>{if(o||!e&&i===null)return;s(!0);let n=new URLSearchParams({limit:`6`,cursor:String(e?0:i??0)});Object.entries(g).forEach(([e,t])=>t&&n.set(e,String(t)));try{let r=await(await fetch(`${aa}/products?${n}`)).json();t(t=>e?r.items:[...t,...r.items]),a(r.nextCursor)}finally{s(!1)}},[i,g,o]);(0,x.useEffect)(()=>{a(0),t([]),y(!0)},[g.search,g.category,g.sort,g.minPrice,g.maxPrice,g.color,g.size]),(0,x.useEffect)(()=>{let e=new IntersectionObserver(([e])=>e.isIntersecting&&y(),{rootMargin:`200px`});return v.current&&e.observe(v.current),()=>e.disconnect()},[y]);function b(e){e.stock<=0||(br({product:e,color:e.colors[0]??``,size:e.sizes[0]??``,quantity:1}),p(e.id),window.setTimeout(()=>p(``),1200))}function ee(e){li(e),h(new Set(oi().map(e=>e.id)))}return(0,M.jsxs)(`div`,{className:`catalog-page`,children:[(0,M.jsx)(`header`,{className:`section-t-space`,children:(0,M.jsx)(`div`,{className:`custom-container`,children:(0,M.jsxs)(`div`,{className:`header-panel`,children:[(0,M.jsx)(j,{to:`/landing`,children:`â†`}),(0,M.jsx)(`h3`,{children:`Products`}),(0,M.jsx)(`button`,{className:`plain-icon-button`,onClick:()=>d(u===`grid`?`list`:`grid`),type:`button`,children:u===`grid`?`â˜·`:`â–¦`})]})})}),(0,M.jsxs)(`div`,{className:`custom-container`,children:[(0,M.jsxs)(`div`,{className:`catalog-search`,children:[(0,M.jsx)(`input`,{onChange:e=>_({...g,search:e.target.value}),placeholder:`Search products...`,value:g.search}),(0,M.jsx)(`button`,{onClick:()=>l(!0),type:`button`,children:`Filter`})]}),(0,M.jsxs)(`div`,{className:`category-slider`,children:[(0,M.jsx)(`button`,{className:g.category?``:`active`,onClick:()=>_({...g,category:``}),children:`All`}),n.map(e=>(0,M.jsx)(`button`,{className:g.category===e.id?`active`:``,onClick:()=>_({...g,category:e.id}),children:e.name},e.id))]}),(0,M.jsx)(`div`,{className:`dynamic-products ${u}`,children:e.map(e=>(0,M.jsxs)(`article`,{className:`dynamic-product-card`,children:[(0,M.jsx)(`button`,{"aria-label":m.has(e.id)?`Remove from wishlist`:`Add to wishlist`,className:`product-favorite-button ${m.has(e.id)?`active`:``}`,onClick:()=>ee(e),type:`button`,children:m.has(e.id)?`â™¥`:`â™¡`}),(0,M.jsx)(j,{to:`/product-details/${e.id}`,children:(0,M.jsx)(`img`,{alt:e.name,loading:`lazy`,src:e.images[0]})}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h4`,{children:e.name}),(0,M.jsx)(`p`,{children:e.description}),(0,M.jsxs)(`div`,{className:`product-card-footer`,children:[(0,M.jsxs)(`strong`,{children:[`$`,e.price.toFixed(2)]}),(0,M.jsxs)(`span`,{children:[`â˜… `,e.rating.toFixed(1)]})]}),(0,M.jsx)(`button`,{className:`quick-add-button`,disabled:!e.stock,onClick:()=>b(e),type:`button`,children:f===e.id?`Added âœ“`:e.stock?`Add to cart`:`Out of stock`})]})]},e.id))}),!e.length&&!o&&(0,M.jsx)(`div`,{className:`empty-state`,children:`No products found.`}),(0,M.jsx)(`div`,{className:`infinite-sentinel`,ref:v,children:o?`Loading...`:i===null?`You reached the end`:``})]}),c&&(0,M.jsx)(`div`,{className:`sheet-backdrop`,onClick:()=>l(!1),children:(0,M.jsxs)(`div`,{className:`filter-sheet`,onClick:e=>e.stopPropagation(),children:[(0,M.jsx)(`div`,{className:`sheet-handle`}),(0,M.jsx)(`h3`,{children:`Filter & Sort`}),(0,M.jsxs)(`label`,{children:[`Sort`,(0,M.jsxs)(`select`,{onChange:e=>_({...g,sort:e.target.value}),value:g.sort,children:[(0,M.jsx)(`option`,{value:`newest`,children:`Newest`}),(0,M.jsx)(`option`,{value:`price-asc`,children:`Lowest price`}),(0,M.jsx)(`option`,{value:`price-desc`,children:`Highest price`}),(0,M.jsx)(`option`,{value:`rating`,children:`Highest rating`})]})]}),(0,M.jsxs)(`div`,{className:`filter-row`,children:[(0,M.jsxs)(`label`,{children:[`Min price`,(0,M.jsx)(`input`,{min:`0`,onChange:e=>_({...g,minPrice:e.target.value}),type:`number`,value:g.minPrice})]}),(0,M.jsxs)(`label`,{children:[`Max price`,(0,M.jsx)(`input`,{min:`0`,onChange:e=>_({...g,maxPrice:e.target.value}),type:`number`,value:g.maxPrice})]})]}),(0,M.jsxs)(`label`,{children:[`Size`,(0,M.jsxs)(`select`,{onChange:e=>_({...g,size:e.target.value}),value:g.size,children:[(0,M.jsx)(`option`,{value:``,children:`All sizes`}),(0,M.jsx)(`option`,{children:`S`}),(0,M.jsx)(`option`,{children:`M`}),(0,M.jsx)(`option`,{children:`L`}),(0,M.jsx)(`option`,{children:`Standard`}),(0,M.jsx)(`option`,{children:`Large`})]})]}),(0,M.jsxs)(`div`,{className:`sheet-actions`,children:[(0,M.jsx)(`button`,{onClick:()=>_({search:``,category:``,sort:`newest`,minPrice:``,maxPrice:``,color:``,size:``}),children:`Clear`}),(0,M.jsx)(`button`,{className:`primary`,onClick:()=>l(!1),children:`Apply`})]})]})})]})}var sa=`
 header start 
<header class="section-t-space">
<div class="custom-container">
<div class="header-panel">
...
<h3 class="text-center w-100">Terms and Conditions</h3>
</div>
</div>
</header>
 header end 
...
`;function ca(){return(0,M.jsx)(N,{html:sa})}var la=`html<html lang="en"><meta charset="utf-8"/><meta content="width=device-width,initial-scale=1" name="viewport"/><meta content="#000" name="theme-color"/><title>404: NOT_FOUND</title><style>html{font-size:62.5%;box-sizing:border-box;height:-webkit-fill-available}*,::after,::before{box-sizing:inherit}body{font-family:sf pro text,sf pro icons,helvetica neue,helvetica,arial,sans-serif;font-size:1.6rem;line-height:1.65;word-break:break-word;font-kerning:auto;font-variant:normal;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-rendering:optimizeLegibility;hyphens:auto;height:100vh;height:-webkit-fill-available;max-height:100vh;max-height:-webkit-fill-available;margin:0}::selection{background:#79ffe1}::-moz-selection{background:#79ffe1}a{cursor:pointer;color:#0070f3;text-decoration:none;transition:all .2s ease;border-bottom:1px solid #0000}a:hover{border-bottom:1px solid #0070f3}ul{padding:0;margin-left:1.5em;list-style-type:none}li{margin-bottom:10px}ul li:before{content:'\\02013'}li:before{display:inline-block;color:#ccc;position:absolute;margin-left:-18px;transition:color .2s ease}code{font-family:Menlo,Monaco,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New,monospace,serif;font-size:.92em}code:after,code:before{content:'\`'}.container{display:flex;justify-content:center;flex-direction:column;min-height:100%}main{max-width:80rem;padding:4rem 6rem;margin:auto}ul{margin-bottom:32px}.error-title{font-size:2rem;padding-left:22px;line-height:1.5;margin-bottom:24px}.error-title-guilty{border-left:2px solid #ed367f}.error-title-innocent{border-left:2px solid #59b89c}@media(max-width:500px){.owner-error{display:none}}main p{color:#333}.devinfo-container{border:1px solid #ddd;border-radius:4px;padding:2rem;display:flex;flex-direction:column;margin-bottom:32px}.error-code{margin:0;font-size:1.6rem;color:#000;margin-bottom:1.6rem}.devinfo-line{color:#333}.devinfo-line code,code,li{color:#000}.devinfo-line:not(:last-child){margin-bottom:8px}.docs-link,.contact-link{font-weight:500}header,footer,footer a{display:flex;justify-content:center;align-items:center}header,footer{min-height:100px;height:100px}header{border-bottom:1px solid #eaeaea}header h1{font-size:1.8rem;margin:0;font-weight:500}header p{font-size:1.3rem;margin:0;font-weight:500}.header-item{display:flex;padding:0 2rem;margin:2rem 0;text-decoration:line-through;color:#999}.header-item.active{color:#ff0080;text-decoration:none}.header-item.first{border-right:1px solid #eaeaea}.header-item-content{display:flex;flex-direction:column}.header-item-icon{margin-right:1rem;margin-top:.6rem}footer{border-top:1px solid #eaeaea}footer a{color:#000}footer a:hover{border-bottom-color:#0000}footer svg{margin-left:.8rem}.note{padding:8pt 16pt;border-radius:5px;border:1px solid #0070f3;font-size:14px;line-height:1.8;color:#0070f3}@media(max-width:500px){.devinfo-container .devinfo-line code{margin-top:.4rem}.devinfo-container .devinfo-line:not(:last-child){margin-bottom:1.6rem}.devinfo-container{margin-bottom:0}header{flex-direction:column;height:auto;min-height:auto;align-items:flex-start}.header-item.first{border-right:none;margin-bottom:0}main{padding:1rem 2rem}body{font-size:1.4rem;line-height:1.55}footer{display:none}.note{margin-top:16px}}</style><div class="container"><main><p class="devinfo-container"><span class="error-code"><strong>404</strong>: NOT_FOUND</span>
<span class="devinfo-line">Code: <code>NOT_FOUND</code></span>
<span class="devinfo-line">ID: <code>hkg1::6p5gw-1782696044561-fdde4837ac55</code></span></p><a class="owner-error" href="https://vercel.com/docs/errors/NOT_FOUND"><div class="note">Read our documentation to learn more about this error.</div></a></main></div></html>`;function ua(){return(0,M.jsx)(N,{html:la})}function I(){let[e,t]=(0,x.useState)(oi),[n,r]=(0,x.useState)(``);function i(n){let r=e.filter(e=>e.id!==n);t(r),si(r)}function a(e){e.stock<=0||(br({product:e,color:e.colors[0]??``,size:e.sizes[0]??``,quantity:1}),r(e.id),window.setTimeout(()=>r(``),1200))}return(0,M.jsxs)(`div`,{className:`wishlist-page`,children:[(0,M.jsxs)(`header`,{className:`header-panel custom-container section-t-space`,children:[(0,M.jsx)(j,{to:`/landing`,children:`â†`}),(0,M.jsx)(`h3`,{children:`Wishlist`}),(0,M.jsx)(j,{to:`/cart`,children:`Bag`})]}),(0,M.jsxs)(`main`,{className:`custom-container`,children:[!e.length&&(0,M.jsxs)(`div`,{className:`empty-state`,children:[`Your wishlist is empty. `,(0,M.jsx)(j,{to:`/shop`,children:`Explore products`})]}),e.map(e=>(0,M.jsxs)(`article`,{children:[(0,M.jsx)(j,{to:`/product-details/${e.id}`,children:(0,M.jsx)(`img`,{alt:e.name,src:e.images[0]})}),(0,M.jsxs)(`div`,{className:`wishlist-product-info`,children:[(0,M.jsx)(j,{to:`/product-details/${e.id}`,children:(0,M.jsx)(`h4`,{children:e.name})}),(0,M.jsx)(`p`,{children:e.description}),(0,M.jsxs)(`strong`,{children:[`$`,e.price.toFixed(2)]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`button`,{className:`wishlist-remove`,onClick:()=>i(e.id),type:`button`,children:`Remove`}),(0,M.jsx)(`button`,{className:`wishlist-add`,disabled:!e.stock,onClick:()=>a(e),type:`button`,children:n===e.id?`Added âœ“`:e.stock?`Add to cart`:`Out of stock`})]})]})]},e.id))]})]})}function da({children:e}){let{loading:t,user:n}=Ir(),r=k();return t?(0,M.jsx)(`div`,{className:`auth-loading`,children:`Loading...`}):n?e:(0,M.jsx)(Ut,{to:`/login`,replace:!0,state:{from:r.pathname}})}function fa(){let e=_t(),{refreshUser:t}=Ir();return(0,x.useEffect)(()=>{let n=new URLSearchParams(window.location.hash.slice(1)).get(`token`);if(window.history.replaceState(null,``,`/oauth/callback`),!n){e(`/login?oauth=failed`,{replace:!0});return}jr.set(n),t().then(()=>e(`/landing`,{replace:!0})).catch(()=>e(`/login?oauth=failed`,{replace:!0}))},[e,t]),(0,M.jsx)(`div`,{className:`auth-loading`,children:`Completing sign in...`})}function pa(){return(0,M.jsxs)(`nav`,{className:`admin-navigation`,children:[(0,M.jsx)(Ln,{to:`/admin/users`,children:`Users`}),(0,M.jsx)(Ln,{to:`/admin/products`,children:`Products`}),(0,M.jsx)(Ln,{to:`/admin/orders`,children:`Orders`}),(0,M.jsx)(Ln,{to:`/landing`,children:`View shop`})]})}var ma=`https://trungfuzzy-api.vercel.app/api`,ha={name:``,description:``,categoryId:`chair`,price:`0`,compareAtPrice:`0`,stock:`0`,images:`/assets/images/product/1.png`,colors:`#122636, #d6a354`,sizes:`S, M, L`,active:!0};function ga(){let[e,t]=(0,x.useState)(()=>sessionStorage.getItem(`fuzzy-admin-key`)??``),[n,r]=(0,x.useState)([]),[i,a]=(0,x.useState)([]),[o,s]=(0,x.useState)(ha),[c,l]=(0,x.useState)(``),[u,d]=(0,x.useState)(``),[f,p]=(0,x.useState)(``),[m,h]=(0,x.useState)(``),g=jr.get(),_={"Content-Type":`application/json`,...e?{"X-Admin-Key":e}:{},...g?{Authorization:`Bearer ${g}`}:{}};async function v(){let[e,t]=await Promise.all([fetch(`${ma}/products?limit=30&includeHidden=true`,{headers:_}).then(e=>e.json()),fetch(`${ma}/categories?includeHidden=true`,{headers:_}).then(e=>e.json())]);r(e.items??[]),a(t.categories??[])}(0,x.useEffect)(()=>{v()},[]);function y(e){l(e.id),s({name:e.name,description:e.description,categoryId:e.categoryId,price:String(e.price),compareAtPrice:String(e.compareAtPrice),stock:String(e.stock),images:e.images.join(`
`),colors:e.colors.join(`, `),sizes:e.sizes.join(`, `),active:e.active}),window.scrollTo({top:0,behavior:`smooth`})}async function b(t){t.preventDefault(),h(``),sessionStorage.setItem(`fuzzy-admin-key`,e);let r={...o,price:Number(o.price),compareAtPrice:Number(o.compareAtPrice),stock:Number(o.stock),rating:c?n.find(e=>e.id===c)?.rating??0:0,images:o.images.split(/\r?\n/).map(e=>e.trim()).filter(Boolean),colors:o.colors.split(`,`).map(e=>e.trim()).filter(Boolean),sizes:o.sizes.split(`,`).map(e=>e.trim()).filter(Boolean)},i=await fetch(`${ma}/products${c?`/${c}`:``}`,{method:c?`PATCH`:`POST`,headers:_,body:JSON.stringify(r)}),a=await i.json();if(!i.ok)return h(a.message);s(ha),l(``),h(`Saved successfully.`),await v()}async function ee(e){confirm(`Hide this product?`)&&(await fetch(`${ma}/products/${e}`,{method:`DELETE`,headers:_}),await v())}async function S(e){let t=await fetch(`${ma}/products/${e.id}`,{method:`PATCH`,headers:_,body:JSON.stringify({active:!0})}),n=await t.json();if(!t.ok)return h(n.message);await v()}async function C(e){e.preventDefault();let t=`${ma}/categories${f?`/${f}`:``}`,n=await fetch(t,{method:f?`PATCH`:`POST`,headers:_,body:JSON.stringify({name:u,icon:`/assets/images/svg/sofa.svg`,active:!0})}),r=await n.json();if(!n.ok)return h(r.message);d(``),p(``),await v()}async function te(e){if(e.active&&!confirm(`Hide category ${e.name}?`))return;let t=await fetch(`${ma}/categories/${e.id}`,{method:`PATCH`,headers:_,body:JSON.stringify({active:!e.active})}),n=await t.json();if(!t.ok)return h(n.message);await v()}return(0,M.jsxs)(`div`,{className:`admin-products-page`,children:[(0,M.jsx)(pa,{}),(0,M.jsxs)(`header`,{children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h1`,{children:`Product Management`}),(0,M.jsx)(`p`,{children:`Products, inventory, variants and categories`})]}),(0,M.jsxs)(`div`,{className:`admin-key-box`,children:[(0,M.jsx)(`input`,{onChange:e=>t(e.target.value),placeholder:`Admin API key`,type:`password`,value:e}),(0,M.jsx)(`button`,{onClick:()=>{sessionStorage.setItem(`fuzzy-admin-key`,e),v()},children:`Connect`})]})]}),(0,M.jsxs)(`main`,{children:[(0,M.jsxs)(`form`,{className:`admin-product-form`,onSubmit:b,children:[(0,M.jsx)(`h2`,{children:c?`Edit product`:`Add product`}),(0,M.jsx)(`input`,{onChange:e=>s({...o,name:e.target.value}),placeholder:`Product name`,required:!0,value:o.name}),(0,M.jsx)(`textarea`,{onChange:e=>s({...o,description:e.target.value}),placeholder:`Description`,required:!0,value:o.description}),(0,M.jsx)(`select`,{onChange:e=>s({...o,categoryId:e.target.value}),value:o.categoryId,children:i.map(e=>(0,M.jsx)(`option`,{value:e.id,children:e.name},e.id))}),(0,M.jsxs)(`div`,{className:`admin-form-row`,children:[(0,M.jsx)(`input`,{min:`0`,onChange:e=>s({...o,price:e.target.value}),placeholder:`Price`,type:`number`,value:o.price}),(0,M.jsx)(`input`,{min:`0`,onChange:e=>s({...o,compareAtPrice:e.target.value}),placeholder:`Old price`,type:`number`,value:o.compareAtPrice}),(0,M.jsx)(`input`,{min:`0`,onChange:e=>s({...o,stock:e.target.value}),placeholder:`Stock`,type:`number`,value:o.stock})]}),(0,M.jsx)(`textarea`,{onChange:e=>s({...o,images:e.target.value}),placeholder:`One image URL per line`,value:o.images}),(0,M.jsx)(`input`,{onChange:e=>s({...o,colors:e.target.value}),placeholder:`Colors, comma separated`,value:o.colors}),(0,M.jsx)(`input`,{onChange:e=>s({...o,sizes:e.target.value}),placeholder:`Sizes, comma separated`,value:o.sizes}),(0,M.jsxs)(`label`,{children:[(0,M.jsx)(`input`,{checked:o.active,onChange:e=>s({...o,active:e.target.checked}),type:`checkbox`}),` Visible`]}),m&&(0,M.jsx)(`p`,{children:m}),(0,M.jsx)(`button`,{type:`submit`,children:c?`Update product`:`Create product`})]}),(0,M.jsxs)(`section`,{className:`admin-category-panel`,children:[(0,M.jsx)(`h2`,{children:`Categories`}),(0,M.jsxs)(`form`,{onSubmit:C,children:[(0,M.jsx)(`input`,{onChange:e=>d(e.target.value),placeholder:`Category name`,required:!0,value:u}),(0,M.jsx)(`button`,{children:f?`Save`:`Add`})]}),(0,M.jsx)(`div`,{children:i.map(e=>(0,M.jsxs)(`span`,{className:e.active?``:`inactive`,children:[e.name,(0,M.jsx)(`button`,{onClick:()=>{p(e.id),d(e.name)},children:`Edit`}),(0,M.jsx)(`button`,{onClick:()=>te(e),children:e.active?`Hide`:`Show`})]},e.id))})]}),(0,M.jsxs)(`section`,{className:`admin-product-table`,children:[(0,M.jsxs)(`h2`,{children:[`Products (`,n.length,`)`]}),n.map(e=>(0,M.jsxs)(`article`,{className:e.active?``:`inactive`,children:[(0,M.jsx)(`img`,{alt:e.name,src:e.images[0]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:e.name}),(0,M.jsxs)(`p`,{children:[`$`,e.price,` Â· Stock `,e.stock,` Â· `,e.sizes.join(`/`)]})]}),(0,M.jsx)(`button`,{onClick:()=>y(e),children:`Edit`}),e.active?(0,M.jsx)(`button`,{onClick:()=>ee(e.id),children:`Hide`}):(0,M.jsx)(`button`,{onClick:()=>S(e),children:`Restore`})]},e.id))]})]})]})}var _a=`https://trungfuzzy-api.vercel.app/api`,va={pending:[`preparing`,`cancelled`],preparing:[`shipping`,`cancelled`],shipping:[`completed`,`cancelled`],completed:[],cancelled:[]};function ya(){let[e,t]=(0,x.useState)(()=>sessionStorage.getItem(`fuzzy-admin-key`)??``),[n,r]=(0,x.useState)([]),[i,a]=(0,x.useState)(``),[o,s]=(0,x.useState)(`all`),[c,l]=(0,x.useState)(``),u=()=>{let t=jr.get();return{...e?{"X-Admin-Key":e}:{},...t?{Authorization:`Bearer ${t}`}:{}}},d=async()=>{let e=await fetch(`${_a}/orders`,{headers:u()}),t=await e.json();if(!e.ok)return a(t.message);r(t.orders),a(``)};(0,x.useEffect)(()=>{d()},[]);async function f(e,t){l(e.id);let n=await fetch(`${_a}/orders/${e.id}`,{method:`PATCH`,headers:{"Content-Type":`application/json`,...u()},body:JSON.stringify({status:t,note:`Admin changed status to ${t}.`})}),r=await n.json();if(!n.ok)return l(``),a(r.message);await d(),l(``)}let p=o===`all`?n:n.filter(e=>e.status===o);return(0,M.jsxs)(`div`,{className:`admin-orders-page`,children:[(0,M.jsx)(pa,{}),(0,M.jsxs)(`header`,{children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h1`,{children:`Order Management`}),(0,M.jsx)(`p`,{children:`Confirm, prepare, ship and complete orders`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`input`,{onChange:e=>t(e.target.value),type:`password`,value:e}),(0,M.jsx)(`button`,{onClick:()=>{sessionStorage.setItem(`fuzzy-admin-key`,e),d()},children:`Connect`})]})]}),(0,M.jsxs)(`section`,{className:`admin-order-metrics`,children:[(0,M.jsxs)(`button`,{className:o===`all`?`active`:``,onClick:()=>s(`all`),children:[(0,M.jsx)(`b`,{children:n.length}),(0,M.jsx)(`span`,{children:`All`})]}),[`pending`,`preparing`,`shipping`,`completed`,`cancelled`].map(e=>(0,M.jsxs)(`button`,{className:o===e?`active`:``,onClick:()=>s(e),children:[(0,M.jsx)(`b`,{children:n.filter(t=>t.status===e).length}),(0,M.jsx)(`span`,{children:e})]},e))]}),(0,M.jsxs)(`main`,{children:[i&&(0,M.jsx)(`p`,{className:`form-message`,children:i}),!p.length&&(0,M.jsx)(`p`,{className:`empty-state`,children:`No orders in this status.`}),p.map(e=>(0,M.jsxs)(`article`,{children:[(0,M.jsxs)(`div`,{className:`admin-order-head`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:e.code}),(0,M.jsx)(`p`,{children:new Date(e.createdAt).toLocaleString()})]}),(0,M.jsx)(`span`,{className:`order-status ${e.status}`,children:e.status})]}),(0,M.jsxs)(`div`,{className:`admin-order-body`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`strong`,{children:e.shippingAddress.recipientName}),(0,M.jsxs)(`p`,{children:[e.shippingAddress.street,`, `,e.shippingAddress.city]}),(0,M.jsxs)(`small`,{children:[e.paymentMethod,` Â· `,e.paymentStatus]})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsxs)(`b`,{children:[`$`,e.total.toFixed(2)]}),(0,M.jsxs)(`p`,{children:[e.items.reduce((e,t)=>e+t.quantity,0),` items`]})]})]}),(0,M.jsx)(`div`,{className:`admin-order-actions`,children:va[e.status].map(t=>(0,M.jsx)(`button`,{className:t===`cancelled`?`danger`:``,disabled:c===e.id,onClick:()=>f(e,t),children:e.status===`pending`&&t===`preparing`?`Approve`:t},t))})]},e.id))]})]})}var ba=`https://trungfuzzy-api.vercel.app/api`;function xa(){let[e,t]=(0,x.useState)(()=>sessionStorage.getItem(`fuzzy-admin-key`)??``),[n,r]=(0,x.useState)([]),[i,a]=(0,x.useState)(``),[o,s]=(0,x.useState)(`all`),[c,l]=(0,x.useState)(``),[u,d]=(0,x.useState)(``),f=()=>{let t=jr.get();return{...e?{"X-Admin-Key":e}:{},...t?{Authorization:`Bearer ${t}`}:{}}};async function p(){let t=new URLSearchParams({search:i,status:o}),n=await fetch(`${ba}/admin/users?${t}`,{headers:f()}),a=await n.json();if(!n.ok)return l(a.message);sessionStorage.setItem(`fuzzy-admin-key`,e),r(a.users),l(``)}(0,x.useEffect)(()=>{p()},[]);async function m(e,t){d(e.id);let n=await fetch(`${ba}/admin/users/${e.id}`,{method:`PATCH`,headers:{"Content-Type":`application/json`,...f()},body:JSON.stringify(t)}),r=await n.json();n.ok||l(r.message),await p(),d(``)}async function h(e){if(!confirm(`Delete account ${e.email}? This cannot be undone.`))return;d(e.id);let t=await fetch(`${ba}/admin/users/${e.id}`,{method:`DELETE`,headers:f()}),n=await t.json();t.ok||l(n.message),await p(),d(``)}let g={all:n.length,pending:n.filter(e=>e.status===`pending`).length,active:n.filter(e=>e.status===`active`).length,locked:n.filter(e=>e.status===`locked`).length};return(0,M.jsxs)(`div`,{className:`admin-users-page`,children:[(0,M.jsx)(pa,{}),(0,M.jsxs)(`header`,{children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h1`,{children:`User Management`}),(0,M.jsx)(`p`,{children:`Approve, lock and remove customer accounts`})]}),(0,M.jsxs)(`div`,{className:`admin-key-box`,children:[(0,M.jsx)(`input`,{onChange:e=>t(e.target.value),placeholder:`Admin API key`,type:`password`,value:e}),(0,M.jsx)(`button`,{onClick:p,children:`Connect`})]})]}),(0,M.jsxs)(`section`,{className:`admin-user-tools`,children:[(0,M.jsx)(`input`,{onChange:e=>a(e.target.value),placeholder:`Search name or email...`,value:i}),(0,M.jsxs)(`select`,{onChange:e=>s(e.target.value),value:o,children:[(0,M.jsxs)(`option`,{value:`all`,children:[`All (`,g.all,`)`]}),(0,M.jsxs)(`option`,{value:`pending`,children:[`Pending (`,g.pending,`)`]}),(0,M.jsxs)(`option`,{value:`active`,children:[`Active (`,g.active,`)`]}),(0,M.jsxs)(`option`,{value:`locked`,children:[`Locked (`,g.locked,`)`]})]}),(0,M.jsx)(`button`,{onClick:p,children:`Search`})]}),(0,M.jsxs)(`main`,{children:[c&&(0,M.jsx)(`p`,{className:`form-message`,children:c}),!n.length&&!c&&(0,M.jsx)(`p`,{className:`empty-state`,children:`No accounts found.`}),n.map(e=>(0,M.jsxs)(`article`,{children:[(0,M.jsx)(`img`,{alt:``,src:e.avatar||`/assets/images/icons/profile1.png`}),(0,M.jsxs)(`div`,{className:`admin-user-info`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:e.fullName}),(0,M.jsx)(`span`,{className:`account-status ${e.status}`,children:e.status})]}),(0,M.jsx)(`p`,{children:e.email}),(0,M.jsxs)(`small`,{children:[e.role,` Â· Joined `,new Date(e.createdAt).toLocaleDateString()]})]}),(0,M.jsxs)(`div`,{className:`admin-user-actions`,children:[e.status===`pending`&&(0,M.jsx)(`button`,{disabled:u===e.id,onClick:()=>m(e,{status:`active`}),children:`Approve`}),e.status===`active`&&(0,M.jsx)(`button`,{className:`warning`,disabled:u===e.id,onClick:()=>m(e,{status:`locked`}),children:`Lock`}),e.status===`locked`&&(0,M.jsx)(`button`,{disabled:u===e.id,onClick:()=>m(e,{status:`active`}),children:`Unlock`}),(0,M.jsx)(`button`,{disabled:u===e.id,onClick:()=>m(e,{role:e.role===`admin`?`customer`:`admin`}),children:e.role===`admin`?`Remove admin`:`Make admin`}),(0,M.jsx)(`button`,{className:`danger`,disabled:u===e.id,onClick:()=>h(e),children:`Delete`})]})]},e.id))]})]})}var Sa=[{to:`/landing`,label:`Home`,icon:`home`},{to:`/categories`,label:`Categories`,icon:`categories`},{to:`/cart`,label:`Cart`,icon:`bag`},{to:`/wishlist`,label:`Wishlist`,icon:`heart`},{to:`/profile`,label:`Profile`,icon:`profile`}],Ca=new Set(Sa.map(e=>e.to));function wa(){let{pathname:e}=k();return Ca.has(e)?(0,M.jsx)(`nav`,{"aria-label":`Main navigation`,className:`app-bottom-nav`,children:Sa.map(e=>(0,M.jsx)(Ln,{"aria-label":e.label,to:e.to,children:({isActive:t})=>(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`img`,{alt:``,src:`/assets/images/svg/${e.icon}${t?`-fill`:``}.svg`}),(0,M.jsx)(`span`,{children:e.label})]})},e.to))}):null}function Ta(){let[e,t]=(0,x.useState)(navigator.onLine);return(0,x.useEffect)(()=>{let e=()=>t(navigator.onLine);return window.addEventListener(`online`,e),window.addEventListener(`offline`,e),()=>{window.removeEventListener(`online`,e),window.removeEventListener(`offline`,e)}},[]),e?null:(0,M.jsx)(`div`,{className:`offline-banner`,role:`status`,children:`KhÃ´ng cÃ³ káº¿t ná»‘i máº¡ng`})}function Ea(){let[e,t]=(0,x.useState)(null),[n,r]=(0,x.useState)(!1),i=/iphone|ipad|ipod/i.test(navigator.userAgent),a=window.matchMedia(`(display-mode: standalone)`).matches||!!navigator.standalone;(0,x.useEffect)(()=>{if(a||localStorage.getItem(`fuzzy-install-dismissed`)===`true`)return;let e=e=>{e.preventDefault(),t(e),r(!0)};return window.addEventListener(`beforeinstallprompt`,e),i&&r(!0),()=>window.removeEventListener(`beforeinstallprompt`,e)},[i,a]);async function o(){if(e){await e.prompt(),(await e.userChoice).outcome===`accepted`&&r(!1),t(null);return}i&&alert(`TrÃªn Safari, nháº¥n nÃºt Chia sáº» rá»“i chá»n "ThÃªm vÃ o MÃ n hÃ¬nh chÃ­nh".`)}function s(){localStorage.setItem(`fuzzy-install-dismissed`,`true`),r(!1)}return!n||a?null:(0,M.jsxs)(`aside`,{className:`install-app-prompt`,children:[(0,M.jsx)(`img`,{alt:``,src:`/assets/images/logo/pwa-icon.svg`}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`strong`,{children:`CÃ i Ä‘áº·t Fuzzy`}),(0,M.jsx)(`p`,{children:`ThÃªm á»©ng dá»¥ng vÃ o mÃ n hÃ¬nh chÃ­nh Ä‘á»ƒ má»Ÿ nhanh vÃ  dÃ¹ng khi offline.`})]}),(0,M.jsx)(`button`,{className:`install-action`,onClick:o,type:`button`,children:`CÃ i Ä‘áº·t`}),(0,M.jsx)(`button`,{"aria-label":`ÄÃ³ng`,className:`install-close`,onClick:s,type:`button`,children:`Ã—`})]})}function Da(){return(0,M.jsxs)(Fn,{children:[(0,M.jsx)(Ta,{}),(0,M.jsx)(Ea,{}),(0,M.jsx)(wa,{}),(0,M.jsxs)(Gt,{children:[(0,M.jsx)(A,{path:`/admin`,element:(0,M.jsx)(Ut,{to:`/admin/users`,replace:!0})}),(0,M.jsx)(A,{path:`/admin/users`,element:(0,M.jsx)(xa,{})}),(0,M.jsx)(A,{path:`/cart`,element:(0,M.jsx)(Cr,{})}),(0,M.jsx)(A,{path:`/admin/products`,element:(0,M.jsx)(ga,{})}),(0,M.jsx)(A,{path:`/admin/orders`,element:(0,M.jsx)(ya,{})}),(0,M.jsx)(A,{path:`/categories`,element:(0,M.jsx)(Or,{})}),(0,M.jsx)(A,{path:`/checkout`,element:(0,M.jsx)(da,{children:(0,M.jsx)(Rr,{})})}),(0,M.jsx)(A,{path:`/coupon`,element:(0,M.jsx)(Br,{})}),(0,M.jsx)(A,{path:`/create-account`,element:(0,M.jsx)(Vr,{})}),(0,M.jsx)(A,{path:`/empty-cart`,element:(0,M.jsx)(Ur,{})}),(0,M.jsx)(A,{path:`/empty-notification`,element:(0,M.jsx)(Gr,{})}),(0,M.jsx)(A,{path:`/empty-order-history`,element:(0,M.jsx)(qr,{})}),(0,M.jsx)(A,{path:`/empty-search`,element:(0,M.jsx)(Yr,{})}),(0,M.jsx)(A,{path:`/empty-wishlist`,element:(0,M.jsx)(Zr,{})}),(0,M.jsx)(A,{path:`/forgot-password`,element:(0,M.jsx)($r,{})}),(0,M.jsx)(A,{path:`/help`,element:(0,M.jsx)(ti,{})}),(0,M.jsx)(A,{path:`/`,element:(0,M.jsx)(ri,{})}),(0,M.jsx)(A,{path:`/landing`,element:(0,M.jsx)(fi,{})}),(0,M.jsx)(A,{path:`/language`,element:(0,M.jsx)(mi,{})}),(0,M.jsx)(A,{path:`/login`,element:(0,M.jsx)(_i,{})}),(0,M.jsx)(A,{path:`/oauth/callback`,element:(0,M.jsx)(fa,{})}),(0,M.jsx)(A,{path:`/manage-address`,element:(0,M.jsx)(da,{children:(0,M.jsx)(vi,{})})}),(0,M.jsx)(A,{path:`/manage-delivery-address`,element:(0,M.jsx)(bi,{})}),(0,M.jsx)(A,{path:`/manage-payment`,element:(0,M.jsx)(Si,{})}),(0,M.jsx)(A,{path:`/ne`,element:(0,M.jsx)(wi,{})}),(0,M.jsx)(A,{path:`/new-address`,element:(0,M.jsx)(da,{children:(0,M.jsx)(Ei,{})})}),(0,M.jsx)(A,{path:`/new-card`,element:(0,M.jsx)(Oi,{})}),(0,M.jsx)(A,{path:`/notification`,element:(0,M.jsx)(Ai,{})}),(0,M.jsx)(A,{path:`/order-details`,element:(0,M.jsx)(Mi,{})}),(0,M.jsx)(A,{path:`/order-history`,element:(0,M.jsx)(Pi,{})}),(0,M.jsx)(A,{path:`/order-tracking`,element:(0,M.jsx)(Ut,{to:`/order-history`,replace:!0})}),(0,M.jsx)(A,{path:`/order-tracking/:orderId`,element:(0,M.jsx)(Ii,{})}),(0,M.jsx)(A,{path:`/other-setting`,element:(0,M.jsx)(Ri,{})}),(0,M.jsx)(A,{path:`/otp`,element:(0,M.jsx)(F,{})}),(0,M.jsx)(A,{path:`/page-listing`,element:(0,M.jsx)(Bi,{})}),(0,M.jsx)(A,{path:`/payment`,element:(0,M.jsx)(Hi,{})}),(0,M.jsx)(A,{path:`/product-details`,element:(0,M.jsx)(Wi,{})}),(0,M.jsx)(A,{path:`/product-details/:productId`,element:(0,M.jsx)(Wi,{})}),(0,M.jsx)(A,{path:`/product2-details`,element:(0,M.jsx)(Ki,{})}),(0,M.jsx)(A,{path:`/profile-setting`,element:(0,M.jsx)(da,{children:(0,M.jsx)(qi,{})})}),(0,M.jsx)(A,{path:`/profile`,element:(0,M.jsx)(da,{children:(0,M.jsx)(Ji,{})})}),(0,M.jsx)(A,{path:`/reset-password`,element:(0,M.jsx)(Xi,{})}),(0,M.jsx)(A,{path:`/search`,element:(0,M.jsx)(Qi,{})}),(0,M.jsx)(A,{path:`/setting`,element:(0,M.jsx)(ea,{})}),(0,M.jsx)(A,{path:`/shipping-address`,element:(0,M.jsx)(na,{})}),(0,M.jsx)(A,{path:`/shipping`,element:(0,M.jsx)(ia,{})}),(0,M.jsx)(A,{path:`/shop`,element:(0,M.jsx)(oa,{})}),(0,M.jsx)(A,{path:`/terms-conditions`,element:(0,M.jsx)(ca,{})}),(0,M.jsx)(A,{path:`/voucher`,element:(0,M.jsx)(ua,{})}),(0,M.jsx)(A,{path:`/wishlist`,element:(0,M.jsx)(I,{})}),(0,M.jsx)(A,{path:`*`,element:(0,M.jsx)(Ut,{to:`/`,replace:!0})})]})]})}tr.createRoot(document.getElementById(`root`)).render((0,M.jsx)(x.StrictMode,{children:(0,M.jsx)(Fr,{children:(0,M.jsx)(Da,{})})})),`serviceWorker`in navigator&&window.addEventListener(`load`,()=>{navigator.serviceWorker.register(`/sw.js`).catch(e=>{console.error(`Service worker registration failed:`,e)})});
